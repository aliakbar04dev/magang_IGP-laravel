...
class HrdtKpiReject extends Model
{
    const CREATED_AT = 'dtcrea';
    const UPDATED_AT = 'dtmodi';

    protected $fillable = [
        'tahun', 'npk', 'revisi', 'kd_pt', 'kd_div', 'npk_atasan', 'submit_pic', 'submit_tgl', 'reject_pic', 'reject_tgl', 'reject_ket', 'approve_atasan', 'approve_atasan_tgl', 'approve_hr', 'approve_hr_tgl', 'submit_review_q1_pic', 'submit_review_q1_tgl', 'approve_review_q1_pic', 'approve_review_q1_tgl', 'reject_review_q1_pic', 'reject_review_q1_tgl', 'reject_review_q1_ket', 'submit_review_q2_pic', 'submit_review_q2_tgl', 'approve_review_q2_pic', 'approve_review_q2_tgl', 'reject_review_q2_pic', 'reject_review_q2_tgl', 'reject_review_q2_ket', 'submit_review_q3_pic', 'submit_review_q3_tgl', 'approve_review_q3_pic', 'approve_review_q3_tgl', 'reject_review_q3_pic', 'reject_review_q3_tgl', 'reject_review_q3_ket', 'submit_review_q4_pic', 'submit_review_q4_tgl', 'approve_review_q4_pic', 'approve_review_q4_tgl', 'reject_review_q4_pic', 'reject_review_q4_tgl', 'reject_review_q4_ket', 'status', 'dtcrea', 'creaby', 'dtmodi', 'modiby', 
    ];

    public function hrdtKpiActRejects() {
        return $this->hasMany('App\HrdtKpiActReject');
    }

    public function hrdtKpiActRejectByItem($kd_item) {
        return HrdtKpiActReject::where('hrdt_kpi_reject_id', $this->id)->where('kd_item', $kd_item);
    }
