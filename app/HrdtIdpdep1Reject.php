...
class HrdtIdpdep1Reject extends Model
{
	...
	public function hrdtIdpdep2s() {
		return $this->hasMany('App\HrdtIdpdep2Reject');
	}

    public function hrdtIdpdep4s() {
        return $this->hasMany('App\HrdtIdpdep4Reject');
    }

    public function hrdtIdpdep5s() {
        return $this->hasMany('App\HrdtIdpdep5Reject');
    }
