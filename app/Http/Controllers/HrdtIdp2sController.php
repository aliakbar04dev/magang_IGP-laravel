...
class HrdtIdp2sController extends Controller
{
    /**
    ...
    public function destroy(Request $request, $id)
    {
        if(Auth::user()->can('hrd-idp-delete')) {
            try {
                ...
                $hrdtidp2 = HrdtIdp2::findOrFail(base64_decode($id));
                $alc = $hrdtidp2->alc;
                if ($request->ajax()) {
                    $status = "OK";
                    ...
                    if(!$hrdtidp2->delete()) {
                        ...
                        //insert logs
                        $log_keterangan = "HrdtIdp2sController.destroy: Delete Kompetensi ".$alc." Berhasil. ".base64_decode($id);
                    ...
                    if(!$hrdtidp2->delete()) {
                        ...
                        return redirect()->route('hrdtidp2s.index');
                    }
                }
