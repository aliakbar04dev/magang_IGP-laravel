    ...
    public function aprovalDeptHeadSQE(Request $request, Builder $htmlBuilder)
    {
       if ($request->ajax()) {
            ...
            ->editColumn('no_pis', function($pistandard) {
                return '<a href="'.route('pisdepthead.show',[base64_encode($pistandard->no_pisigp),base64_encode($pistandard->norev)]).'" data-toggle="tooltip" data-placement="top" title="check Document No Pis '. $pistandard->no_pis .'">'.$pistandard->no_pis.'</a>';
            })
