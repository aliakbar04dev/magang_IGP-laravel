...
class HrdtIdp4sController extends Controller
{
    /**
    ...
    public function destroy(Request $request, $id)
    {
        if(Auth::user()->can('hrd-idp-delete') || Auth::user()->can('hrd-idp-approve-div')) {
            try {
                ...
                $hrdtidp4 = HrdtIdp4::findOrFail(base64_decode($id));
                $program = $hrdtidp4->program;
                if ($request->ajax()) {
                    $status = "OK";
                    ...
                    if(!$hrdtidp4->delete()) {
                        ...
                        //insert logs
                        $log_keterangan = "HrdtIdp4sController.destroy: Delete Program ".$program." Berhasil. ".base64_decode($id);
                    ...
                    if(!$hrdtidp4->delete()) {
                        ...
                        return redirect()->route('hrdtidp4s.index');
                    }
                }
