...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Mapping Komite Investasi
        <small>Mapping Komite Investasi</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><i class="fa fa-files-o"></i> Mapping Komite Investasi</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body form-horizontal">
              ...
              <div class="form-group">
                <div class="col-sm-3">
                  ...
                  {!! Form::select('filter_status', ['ALL' => 'ALL', '2' => 'SUBMIT', '3' => 'BELUM KOMITE', '4' => 'SUDAH KOMITE', '5' => 'APPROVE', '6' => 'REVISI', '7' => 'CANCEL'], null, ['class'=>'form-control select2', 'id' => 'filter_status']) !!}
                </div>
                <div class="col-sm-3">
              ...
              <table id="tblMaster" class="table table-bordered table-striped" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    ...
                    <th style="width: 10%;">Tgl Komite</th>
                    <th>Jenis Komite</th>
                    <th>No. IA/EA</th>
            ...
            <div class="box-footer">
              <button id="btnemail" type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Send Email Komite">
              <span class="glyphicon glyphicon-send"></span> Send Email Komite
              </button>
            </div>
            <!-- /.box -->
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var tableMaster = $('#tblMaster').DataTable({
      ...
      // serverSide: true,
      ajax: "{{ route('dashboardall.bgttkomite1s') }}",
      columns: [
      	{data: null, name: null},
        {data: 'email', name: 'email', className: "dt-center", orderable: false, searchable: false}, 
    ...
    $('#tblMaster tbody').on( 'click', 'tr', function () {
      if ($(this).hasClass('selected') ) {
        ...
        if(tableMaster.rows().count() > 0) {
          ...
          var no_komite = tableMaster.cell(index, 2).data();
    ...
    $('#btnemail').click( function () {
      ...
      for($i = 0; $i < table.rows().count(); $i++) {
        ...
        if(document.getElementById(target) != null) {
          ...
          if(checked == true) {
            var no_komite = document.getElementById(target).value.trim();
            validasi = "T";
            if(ids === '-') {
              ids = no_komite;
            } else {
              ids = ids + "#quinza#" + no_komite;
            }
            jmldata = jmldata + 1;
          }
        }
      ...
      if(validasi === "T") {
        ...
        swal({
          title: 'Anda yakin Send Email Komite tsb?',
          text: 'Jumlah Komite: ' + jmldata,
          type: 'question',
          showCancelButton: true,
          confirmButtonColor: '#3085d6',
          cancelButtonColor: '#d33',
          confirmButtonText: '<i class="glyphicon glyphicon-thumbs-up"></i> Yes, Send!',
          ...
          var url = "{{ route('bgttkomite1s.sendemail')}}";
          $("#loading").show();
          $.ajax({
            type     : 'POST',
            url      : url,
            ...
            success:function(data){
              $("#loading").hide();
              if(data.status === 'OK'){
                swal("Send", data.message, "success");
