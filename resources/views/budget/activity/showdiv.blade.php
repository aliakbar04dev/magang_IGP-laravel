...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        CR Activities [Div]
        <small>Detail CR Activities [Approval Div. Head]</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> Budget - TRANSAKSI</li>
        <li><a href="{{ route('bgttcrregiss.indexdiv') }}"><i class="fa fa-files-o"></i> CR Activities</a></li>
    ...
    <section class="content">
      ...
      <div class="box-footer">
        @if ($bgttcrregis->checkKdDiv() === "T" && $bgttcrregis->status === "APPROVE DEPT")
          @if (Auth::user()->can('budget-cr-activities-approve-div'))
            <button id='btnapprove' type='button' class='btn btn-primary' data-toggle='tooltip' data-placement='top' title='Approve Activities - Div. Head' onclick='approve()'>
              <span class='glyphicon glyphicon-check'></span> Approve Div. Head
            </button>
            &nbsp;&nbsp;
            <button id='btnreject' type='button' class='btn btn-danger' data-toggle='tooltip' data-placement='top' title='Reject Activities - Div. Head' onclick='reject()'>
              <span class='glyphicon glyphicon-remove'></span> Reject Div. Head
            </button>
            &nbsp;&nbsp;
          @endif
        @endif
        <a class="btn btn-primary" href="{{ route('bgttcrregiss.indexdiv') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Daftar CR Activities">Cancel</a>
      </div>
    </section>
    <!-- /.content -->
  </div>
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          if(data.status === 'OK'){
            ...
            var urlRedirect = "{{ route('bgttcrregiss.showdiv', 'param') }}";
