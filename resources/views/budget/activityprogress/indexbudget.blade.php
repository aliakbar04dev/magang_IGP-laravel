  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>CR Activities Progress [Approval Budget]</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> Budget - TRANSAKSI</li>
        <li class="active"><i class="fa fa-files-o"></i> CR Activities Progress [Budget]</li>
      </ol>
    </section>
          ...
          <div class="box box-primary">
            ...
            @permission('budget-cr-activities-approve-budget')
              <div class="box-footer">
                <button id="btnapprove" type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Approve Budget">
                  <span class="glyphicon glyphicon-check"></span> Approve Budget
                </button>
                <button id="btnreject" type="button" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Reject Budget">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var tableMaster = $('#tblMaster').DataTable({
      ...
      // serverSide: true,
      ajax: "{{ route('bgttcrsubmits.dashboardbudget') }}",
      columns: [
        {data: null, name: null},
    ...
    $('#btnapprove').click( function () {
      ...
      if(validasi === "T") {
        ...
        swal({
          ...
          formData.append('status_approve', window.btoa('BUDGET'));
      ...
      if(validasi === "T") {
        ...
        swal({
          ...
          swal({
            ...
            formData.append('_token', token);
            formData.append('ids', ids);
            formData.append('status_reject', window.btoa('BUDGET'));
