  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box-footer">
        @if (Auth::user()->can('budget-komiteapproval'))
          @if ($bgttkomite1->notulen == null)
            <a class="btn btn-primary" href="{{ route('bgttkomite1s.mapping', base64_encode($bgttkomite1->no_komite)) }}" data-toggle="tooltip" data-placement="top" title="Mapping Komite">Mapping Komite</a>
            &nbsp;&nbsp;
          @else 
          ...
          @endif
        @endif
        <a class="btn btn-primary" href="{{ route('bgttkomite1s.all') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Daftar Mapping Komite Investasi">Cancel</a>
      </div>
    </section>
    <!-- /.content -->
  </div>
