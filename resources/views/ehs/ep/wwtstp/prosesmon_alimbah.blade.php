...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Laporan Level Instalasi Air Limbah
        <small>Laporan Level Instalasi Air Limbah</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> Laporan</li>
        <li class="active"><i class="fa fa-files-o"></i> Level Instalasi Air Limbah</li>
      </ol>
    </section>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('#btn-proses').click( function () {
      ...
      var test = 'test' 
      var url = "{{ route('ehsenvreps.grafik_alimbah', 'param') }}";
