						...
						<table width="100%">
							<tr>
								...
								<th style='text-align: center'>
									{{-- <center> --}}
										<h4>Monitoring Level Instalasi Air Limbah {{ \Carbon\Carbon::createFromFormat('Ym', $tahun."".$bulan)->format('F Y') }}</h4>
									{{-- </center> --}}
								</th>
					...
					<div class="panel-body">
						...
						<div class="freeze-table">
							<table style="background: black;color: white;" class="table table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
									@foreach ($level_airlimbah_reps->get() as $data)
										<tr>
											...
											<td style='text-align: center'>
												@if ($data->t01 != null)
													...
													@elseif ($data->t01 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('01')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t02 != null)
													...
													@elseif ($data->t02 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('02')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t03 != null)
													...
													@elseif ($data->t03 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('03')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t04 != null)
													...
													@elseif ($data->t04 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('04')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t05 != null)
													...
													@elseif ($data->t05 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('05')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t06 != null)
													...
													@elseif ($data->t06 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('06')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t07 != null)
													...
													@elseif ($data->t07 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('07')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t08 != null)
													...
													@elseif ($data->t08 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('08')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t09 != null)
													...
													@elseif ($data->t09 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('09')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t10 != null)
													...
													@elseif ($data->t10 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('10')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t11 != null)
													...
													@elseif ($data->t11 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('11')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t12 != null)
													...
													@elseif ($data->t12 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('12')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t13 != null)
													...
													@elseif ($data->t13 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('13')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t14 != null)
													...
													@elseif ($data->t14 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('14')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t15 != null)
													...
													@elseif ($data->t15 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('15')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t16 != null)
													...
													@elseif ($data->t16 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('16')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t17 != null)
													...
													@elseif ($data->t17 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('17')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t18 != null)
													...
													@elseif ($data->t18 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('18')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t19 != null)
													...
													@elseif ($data->t19 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('19')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t20 != null)
													...
													@elseif ($data->t20 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('20')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t21 != null)
													...
													@elseif ($data->t21 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('21')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t22 != null)
													...
													@elseif ($data->t22 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('22')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t23 != null)
													...
													@elseif ($data->t23 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('23')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t24 != null)
													...
													@elseif ($data->t24 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('24')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t25 != null)
													...
													@elseif ($data->t25 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('25')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t26 != null)
													...
													@elseif ($data->t26 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('26')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t27 != null)
													...
													@elseif ($data->t27 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('27')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t28 != null)
													...
													@elseif ($data->t28 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('28')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t29 != null)
													...
													@elseif ($data->t29 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('29')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t30 != null)
													...
													@elseif ($data->t30 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('30')">
													@else 
											...
											<td style='text-align: center'>
												@if ($data->t31 != null)
													...
													@elseif ($data->t31 == "W")
														<img src="{{ asset("images/yellow_16.png") }}" ondblclick="popup('31')">
													@else 
...
<script>
    ...
    $('#display').click( function () {
	  ...
	  var urlRedirect = "{{ route('ehsenvreps.monitoring_alimbah', ['param','param2']) }}";
