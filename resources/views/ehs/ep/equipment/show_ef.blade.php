...
@section('content')
 ...
 <div id="myModal" role="dialog" data-backdrop="static"  class="modal" >
    <div class="modal-dialog">  
            <div class="modal-body">
            <a type="button" class="btn btn-sm btn-danger btn_hapus glyphicon glyphicon-remove" id="close" data-dismiss="modal" style="float:right;"></a> 
...
var modalImg = document.getElementById("img01");
 ...
 $('#myImgvalve').click( function () {
  modal.style.display = "block";
  modalImg.src = this.src;
   });

 $('#myImgpompa').click( function () {
  modal.style.display = "block";
  modalImg.src = this.src;
   });

  $('#myImgradar').click( function () {
   modal.style.display = "block";
  modalImg.src = this.src;
   });

  $('#myImgbak').click( function () {
   modal.style.display = "block";
  modalImg.src = this.src;
   });

  $('#myImgspit').click( function () {
   modal.style.display = "block";
   modalImg.src = this.src;
   });
