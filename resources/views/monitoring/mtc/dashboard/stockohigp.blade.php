      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <center><h3 class="box-title" id="box-title" name="box-title" style="font-family:serif;font-size: 30px;"><strong>STOCK SPARE PART MESIN</strong></h3></center>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title">
                        <p><label id="info-detail">Item</label></p>
                      </h3>
                      <div class="box-tools pull-right">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      var tableMaster = $('#tblMaster').DataTable({
        ...
        // serverSide: true,
        ajax: "{{ route('smartmtcs.dashboardstockohigp') }}",
        columns: [
          {data: null, name: null},
          {data: 'item', name: 'item'},
      ...
      var tblMesin = $('#tblMesin').DataTable({
        ...
        "dom": '<"top"fli>rt<"bottom"p><"clear">', 
        // serverSide: true,
        ajax: "{{ route('smartmtcs.dashboardmesinstockohigp') }}",
        columns: [
          {data: null, name: null},
          {data: 'kd_mesin', name: 'kd_mesin'}, 
