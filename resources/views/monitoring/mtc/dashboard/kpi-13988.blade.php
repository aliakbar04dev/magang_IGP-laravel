            ...
            <table id="tblMaster" class="table table-bordered" border="2" width="100%">
              ...
              <tr>
                <td style="width: 45%;text-align: center">
                  <center><img src="{{ $smartmtc->fotokpi($npk."_MA_AS-D.png") }}" class="img-rounded img-responsive" alt="File Not Found" style="width: 100%;height: 100%;" data-toggle="modal" data-target="#imgModal" onclick="showPict('Picture', '{{ $smartmtc->fotokpi($npk."_MA_AS-D.png") }}')"></center>
                </td>
                <td style="width: 45%;text-align: center">
                  <center><img src="{{ $smartmtc->fotokpi($npk."_MA_HOUSING-B.png") }}" class="img-rounded img-responsive" alt="File Not Found" style="width: 100%;height: 100%;" data-toggle="modal" data-target="#imgModal" onclick="showPict('Picture', '{{ $smartmtc->fotokpi($npk."_MA_HOUSING-B.png") }}')"></center>
                </td>
              </tr>
              <tr>
                <td style="width: 45%;text-align: center">
                  <center><img src="{{ $smartmtc->fotokpi($npk."_MA_AS-E.png") }}" class="img-rounded img-responsive" alt="File Not Found" style="width: 100%;height: 100%;" data-toggle="modal" data-target="#imgModal" onclick="showPict('Picture', '{{ $smartmtc->fotokpi($npk."_MA_AS-E.png") }}')"></center>
                </td>
                <td style="width: 45%;text-align: center">
                  &nbsp;
                </td>
              ...
              <tr>
                <td style="width: 45%;text-align: center">
                  <center><img src="{{ $smartmtc->fotokpi($npk."_PMA_AS-D.png") }}" class="img-rounded img-responsive" alt="File Not Found" style="width: 100%;height: 100%;" data-toggle="modal" data-target="#imgModal" onclick="showPict('Picture', '{{ $smartmtc->fotokpi($npk."_PMA_AS-D.png") }}')"></center>
                </td>
                <td style="width: 45%;text-align: center">
                  <center><img src="{{ $smartmtc->fotokpi($npk."_PMA_HOUSING-B.png") }}" class="img-rounded img-responsive" alt="File Not Found" style="width: 100%;height: 100%;" data-toggle="modal" data-target="#imgModal" onclick="showPict('Picture', '{{ $smartmtc->fotokpi($npk."_PMA_HOUSING-B.png") }}')"></center>
                </td>
              </tr>
              <tr>
                <td style="width: 45%;text-align: center">
                  <center><img src="{{ $smartmtc->fotokpi($npk."_PMA_AS-E.png") }}" class="img-rounded img-responsive" alt="File Not Found" style="width: 100%;height: 100%;" data-toggle="modal" data-target="#imgModal" onclick="showPict('Picture', '{{ $smartmtc->fotokpi($npk."_PMA_AS-E.png") }}')"></center>
                </td>
                <td style="width: 45%;text-align: center">
                  &nbsp;
                </td>
