			...
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div>
							<img src="{{ asset('images/green_16.png') }}" alt="X"> NG
							<img src="{{ asset('images/red_16.png') }}" alt="X"> OK
							<img src="{{ asset('images/white_16.png') }}" alt="X"> NY 
						</div>
								...
								<table id="tblMaster" class="main-table table-bordered" cellspacing="0" width="100%">
									<thead>
										<tr>
											...
											<th rowspan="2" class="fixed-side" scope="col" style='text-align: center;vertical-align: middle;'>Lokasi</th>
