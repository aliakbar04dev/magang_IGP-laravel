					...
					<div class="panel-body">
						<table id="tblMaster" class="table table-bordered table-striped" cellspacing="0" width="100%">
	    			    	<thead>
				                ...
				                <th style='width: 10%;text-align: center'>PRC</th>
				                <th style='width: 15%;text-align: center'>User</th>
				                <th style='width: 7%;text-align: center'>PP 26-29</th>
				                <th style='width: 7%;text-align: center'>PO 30-02</th>
				                <th style='width: 7%;text-align: center'>LPB 05-27</th>
	    			        </thead>
	    			    </table>
					</div>
				</div>
...
<script>
	$(document).ready(function(){
	    ...
	    var url = '{{ route('dashboard.pppolpb', 'param') }}';
