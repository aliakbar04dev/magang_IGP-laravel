            ...
            <div class="col-md-12">
                <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title text-center"> <strong>DEPARTEMENT HEAD</strong> </h3>
                        </div>
                        <div class="box-body">
                                    ...
                                    <div id="filter" class="col-lg-8">
                                        <div class="input-group">
                                            <select style="cursor:pointer;" id="filter_statuspkl" name="filter_statuspkl" aria-controls="filter_status" class="form-control">
                                                    ...
                                                    <option value="BELUM DI APPROVE" selected="selected">Belum Approve</option>
...
<script>
    ...
    $('#form_sementara').submit(function(e) {
        e.preventDefault();
        swal({
            title: 'Anda Yakin Mengapprove PKL ini ?',
            text: '',
            type: 'question',
