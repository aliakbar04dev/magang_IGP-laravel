...
<p>
	Telah ditolak Daftar Masalah dengan No: <strong>{{ $mtctdftmslh->no_dm }}</strong> oleh {{ $oleh }}: <strong>{{ Auth::user()->name }} ({{ Auth::user()->username }})</strong> dengan detail sebagai berikut:
</p>
...
<p>
	...
	@endif
	- Keterangan Reject: <strong>{{ $mtctdftmslh->rjt_st }} - {{ $mtctdftmslh->rjt_ket }}.</strong><br>
</p>
