...
<p>
	Kepada: <strong>PIC Laporan Pekerjaan</strong>
</p>

<p>
	Telah diselesaikan Laporan Pekerjaan dengan No: <strong>{{ $tmtcwo1->no_wo }}</strong> oleh: <strong>{{ Auth::user()->name }} ({{ Auth::user()->username }})</strong> dengan detail sebagai berikut:
</p>
