...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pengisian Oli
        <small>Update Pengisian Oli</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Update Pengisian Oli</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Update Pengisian Oli</h3>
        </div>
        <!-- /.box-header -->
        
        <!-- form start -->
        {!! Form::model($mtctisioli1, ['url' => route('mtctisioli1s.update', base64_encode($mtctisioli1->no_isi)),
