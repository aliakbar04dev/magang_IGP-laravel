      ...
      <div class="box-footer">
        @if (Auth::user()->can(['mgt-gembaehs-create','mgt-gembaehs-delete']) && $mgmtgemba->checkEdit() === "T")
          @if (Auth::user()->can('mgt-gembaehs-create'))
            <a class="btn btn-primary" href="{{ route('mgmtgembaehss.edit', base64_encode($mgmtgemba->no_gemba)) }}" data-toggle="tooltip" data-placement="top" title="Ubah Data">Ubah Data</a>
            &nbsp;&nbsp;
          @endif
          ...
          @endif
        @endif
        <a class="btn btn-primary" href="{{ route('mgmtgembaehss.index') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Dashboard Daftar EHS Patrol">Cancel</a>
      </div>
    </section>
    <!-- /.content -->
  </div>
