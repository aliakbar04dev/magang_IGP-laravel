...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Daftar Genba BOD
        <small>Daftar Genba BOD</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> MANAGEMENT - Transaksi</li>
        <li class="active"><i class="fa fa-files-o"></i> Daftar Genba BOD</li>
      </ol>
    </section>
	        ...
	        <div class="col-md-12">
              ...
              <div class="box-header">
                <p> 
                  ...
                  <a class="btn btn-primary" href="{{ route('mgmtgembas.create') }}">
                    <span class="fa fa-plus"></span> Add Genba BOD
                  </a>
                  &nbsp;&nbsp;
                  @endpermission
                  <a class="btn btn-primary" href="{{ route('mgmtgembas.laporan') }}">
                    <span class="fa fa-print"></span> Laporan Genba BOD
                  </a>
                </p>
              </div>
              <!-- /.box-header -->
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var url = '{{ route('dashboard.mgmtgembas') }}';
