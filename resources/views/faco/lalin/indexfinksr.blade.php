...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Lalu Lintas - Finance ke Kasir
        {{-- <small>Lalu Lintas - Finance ke Kasir</small> --}}
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> FACO - Lalu Lintas</li>
        <li class="active"><i class="fa fa-files-o"></i> Finance ke Kasir</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header">
              <p> 
                @permission(['faco-lalin-fin-ksr'])
                <a class="btn btn-primary" href="{{ route('lalins.createfinksr') }}">
                  <span class="fa fa-plus"></span> Serah dari Finance ke Kasir
                </a>
                @endpermission
              </p>
            </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var url = '{{ route('lalins.dashboardfinksr') }}';
      ...
      columns: [
        ...
        {data: 'tgl_lfk', name: 'tgl_lfk', className: "dt-center"},
        {data: 'ket_lfk', name: 'ket_lfk'},
