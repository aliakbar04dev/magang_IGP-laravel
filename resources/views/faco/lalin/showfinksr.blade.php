...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Lalu Lintas
        <small>Detail Finance ke Kasir</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Detail {{ $data->no_lfk }}</li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Finance ke Kasir</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-striped" cellspacing="0" width="100%">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 15%;">{{ $data->no_lfk }}</td>
                    <td style="width: 8%;"><b>Tanggal</b></td>
                    <td style="width: 1%;"><b>:</b></td>
                    <td>
                      {{ \Carbon\Carbon::parse($data->tgl_lfk)->format('d/m/Y') }}
                    </td>
                  </tr>
                  <tr>
                    <td style="width: 12%;"><b>Keterangan</b></td>
                    <td style="width: 1%;"><b>:</b></td>
                    <td colspan="4">{{ $data->ket_lfk }}</td>
                  </tr>
                  <tr>
                  ...
                  @endif
                  <tr>
                    <td colspan="4"><b>Total Serah ke KASIR/Total Voucher Dari Kasir</b></td>
                    <td style="width: 1%;"><b>:</b></td>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body" id="field" data-field-id="{{ $data->no_lfk }}">
              <table id="tblDetail" class="table table-bordered table-hover" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    ...
                    <th style="width: 10%;">ACC ke FIN</th>
                  </tr>
                </thead>
              </table>
            </div>
      ...
      <div class="box-footer">
        @if (Auth::user()->can('faco-lalin-fin-ksr'))
          <a class="btn btn-success" href="{{ route('lalins.edit', base64_encode($data->no_lfk)) }}" data-toggle="tooltip" data-placement="top" title="Ubah Data">
            <span class="glyphicon glyphicon-edit"></span> Ubah Data
          </a>
          &nbsp;&nbsp;
        @endif
        @if (Auth::user()->can('faco-lalin-fin-ksr-approve'))
          <a class="btn btn-primary" href="{{ route('lalins.terimafinksr', base64_encode($data->no_lfk)) }}" data-toggle="tooltip" data-placement="top" title="Terima Data">
            <span class="glyphicon glyphicon-check"></span> Terima Data
          </a>
          &nbsp;&nbsp;
        @endif
        <a class="btn bg-black" href="{{ route('lalins.indexfinksr') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Daftar Finance ke Kasir">Cancel</a>
      </div>
    </section>
    <!-- /.content -->
  </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    var no_lfk = $('#field').data("field-id");
