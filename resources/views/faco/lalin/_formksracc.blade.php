<div class="box-body">
  ...
  <div class="form-group">
    <div class="col-sm-6 {{ $errors->has('ket_lka') ? ' has-error' : '' }}">
      ...
      @else
        @if($jml_tarik > 0)
          {!! Form::text('ket_lka', null, ['class' => 'form-control', 'placeholder' => 'Keterangan', 'maxlength' => 50, 'readonly' => 'readonly']) !!}
        @else 
...
<div class="box-footer">
  ...
  @endif
  &nbsp;&nbsp;
  <a class="btn bg-black" href="{{ route('lalins.indexksracc') }}">Cancel</a>
...
<script type="text/javascript">
  ...
  $("#btn-pilih").click(function(){
    ...
    if(validasi === "T") {
      ...
      url = url.replace('param3', window.btoa(no_lka));
  ...
  function deleteDetail(no_lka, no_voucher) {
