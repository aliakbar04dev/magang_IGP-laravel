...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Lalu Lintas
        <small>Terima Accounting ke Finance</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Terima {{ $data->no_laf }}</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Terima Accounting ke Finance</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
