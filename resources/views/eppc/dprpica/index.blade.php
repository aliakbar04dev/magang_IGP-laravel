...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        PICA DPR
        <small>Daftar PICA DPR</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> E-PPC - Transaksi</li>
        <li class="active"><i class="fa fa-exchange"></i> PICA DPR</li>
      </ol>
    </section>
                ...
                <table id="tblMaster" class="table table-bordered table-striped" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th style="width: 15%;">No. PICA DPR</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    var tableMaster = $('#tblMaster').DataTable({
      ...
      serverSide: true,
      ajax: "{{ route('dashboard.ppctdprpicas') }}",
      columns: [
        ...
        {data: 'rem_ket', name: 'rem_ket'},
        {data: 'com_ket', name: 'com_ket'},
