...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Daftar Inisial
        <small>Daftar Inisial</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="glyphicon glyphicon-info-sign"></i> Employee Info</li>
        <li class="active"><i class="fa fa-files-o"></i> Daftar Inisial</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Daftar Inisial</h3>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var tableDetail = $('#tblDetail').DataTable({
      ...
      serverSide: true,
      ajax: "{{ route('mobiles.dashboarddaftarinitial') }}",
      columns: [
