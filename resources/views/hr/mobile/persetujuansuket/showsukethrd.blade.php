...
@section('content')
 ...
 <li><a href="{{ route('mobiles.suketpengajuan') }}"><i class="fa fa-files-o"></i> Daftar Pengajuan Suket </a></li>
        <li class="active"><i class="fa fa-files-o"></i>Detail Pengajuan</li>
      </ol>
    </section>
                ...
                <div class="box-body">
                   ...
                   {{--  @if (session('status'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            {!! Form::text('nosk', $datasuket->nosk , ['class' => 'form-control', 'readonly' => '']) !!}                            
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            {!! Form::text('tglsurat', Carbon\Carbon::parse($datasuket->tglsurat)->format('d-m-Y'), ['class' => 'form-control', 'readonly' => '']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            {!! Form::text('nama', $datasuket->nama, ['class' => 'form-control', 'readonly' => '']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            {!! Form::text('status',$datasuket->status, ['class' => 'form-control', 'readonly' => '']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row {{ $errors->has('keperluan') ? ' has-error' : '' }}">
                        ...
                        {!! Form::textarea('keperluan', $datasuket->keperluan, ['class'=>'form-control' , 'readonly' => '']) !!}
