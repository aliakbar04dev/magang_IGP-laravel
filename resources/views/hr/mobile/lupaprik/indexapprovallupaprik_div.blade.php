...
var tableDetail = $('#tblDetail').DataTable({
   ...
   //   responsive: true,
      ...
      ajax: "{{ route('mobiles.dashboardapprovallupaprik_divhead') }}",
      columns: [
  ...
  function konfirmasitolak(id)
  {
      ...
      swal({
       ...
       var urlRedirect = "{{route('mobiles.tolakapprovallupaprik_divhead', 'param')}}";    
  ...
  function konfirmasisetuju(id)
   {
      ...
      swal({
        ...
        focusCancel: true,
          ...
          var urlRedirect = "{{route('mobiles.setujuapprovallupaprik_divhead', 'param')}}";    
          urlRedirect = urlRedirect.replace('param', id);
        $.ajax({
          url      : urlRedirect,
          type     : 'GET',
