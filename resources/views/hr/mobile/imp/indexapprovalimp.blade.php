  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-files-o"></i> Daftar IMP </li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
                 <h3 class="box-title">Daftar Approval IMP</h3>
...
var tableDetail = $('#tblDetail').DataTable({
   ...
   //   responsive: true,
      ...
      ajax: "{{ route('mobiles.dashboardapprovalimp') }}",
      columns: [
