...
<p>
	Telah disubmit Individual Development Plan Department Head oleh Div Head: {{ Auth::user()->name }} ({{ Auth::user()->username }}) pada tanggal {{ \Carbon\Carbon::now()->format('d M Y H:i') }} dengan detail sebagai berikut:
</p>
