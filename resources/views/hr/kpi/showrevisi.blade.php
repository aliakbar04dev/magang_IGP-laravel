...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        History KPI Division
        <small>Detail History KPI Division <b>{{ $hrdtkpireject->desc_div." ".$hrdtkpireject->tahun }}</b></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> KPI Division</a></li>
        <li class="active">Detail History KPI Division {{ $hrdtkpireject->tahun }}</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Detail History KPI Division <b>{{ $hrdtkpireject->desc_div." ".$hrdtkpireject->tahun }}</b></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-striped" cellspacing="0" width="100%">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 25%;">{{ $hrdtkpireject->tahun }}</td>
                    <td style="width: 10%;"><b>Company Plan</b></td>
                    <td style="width: 1%;"><b>:</b></td>
                    <td>
                      <a target="_blank" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Show Activity {{ $hrdtkpireject->tahun }}" href="{{ route('hrdtkpis.downloadcp', base64_encode($hrdtkpireject->tahun)) }}"><span class="glyphicon glyphicon-download-alt"></span> Show Activity</a>
                    </td>
                  </tr>
                  <tr>
                    <td style="width: 5%;"><b>PT</b></td>
                    <td style="width: 1%;"><b>:</b></td>
                    <td style="width: 25%;">{{ $hrdtkpireject->kd_pt." - ".$hrdtkpireject->nm_pt }}</td>
                    <td style="width: 10%;"><b>Name</b></td>
                    <td style="width: 1%;"><b>:</b></td>
                    <td>{{ $hrdtkpireject->npk." - ".$hrdtkpireject->masKaryawan($hrdtkpireject->npk)->nama }}</td>
                  </tr>
                  <tr>
                    <td style="width: 5%;"><b>Divisi</b></td>
                    <td style="width: 1%;"><b>:</b></td>
                    <td style="width: 25%;">{{ $hrdtkpireject->kd_div." - ".$hrdtkpireject->desc_div }}</td>
                    <td style="width: 10%;"><b>Superior</b></td>
                    <td style="width: 1%;"><b>:</b></td>
                    <td>{{ $hrdtkpireject->npk_atasan." - ".$hrdtkpireject->namaByNpk($hrdtkpireject->npk_atasan) }}</td>
                  </tr>
                  @if (!empty($hrdtkpireject->submit_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Submit</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->submit_pic." - ".$hrdtkpireject->nama($hrdtkpireject->submit_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->submit_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->approve_atasan_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Approve Superior</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->approve_atasan." - ".$hrdtkpireject->nama($hrdtkpireject->approve_atasan) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->approve_atasan_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->approve_hr_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Approve HRD</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->approve_hr." - ".$hrdtkpireject->nama($hrdtkpireject->approve_hr) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->approve_hr_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->reject_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Reject</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->reject_pic." - ".$hrdtkpireject->nama($hrdtkpireject->reject_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->reject_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                    <tr>
                      <td style="width: 5%;"><b>Ket. Reject</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">{{ $hrdtkpireject->reject_ket }}</td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->submit_review_q1_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Submit Review Q1</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->submit_review_q1_pic." - ".$hrdtkpireject->nama($hrdtkpireject->submit_review_q1_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->submit_review_q1_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->approve_review_q1_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Approve Review Q1</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->approve_review_q1_pic." - ".$hrdtkpireject->nama($hrdtkpireject->approve_review_q1_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->approve_review_q1_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->reject_review_q1_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Reject Review Q1</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->reject_review_q1_pic." - ".$hrdtkpireject->nama($hrdtkpireject->reject_review_q1_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->reject_review_q1_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                    <tr>
                      <td style="width: 5%;"><b>Ket. Reject Review Q1/b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">{{ $hrdtkpireject->reject_review_q1_ket }}</td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->submit_review_q2_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Submit Review Q2</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->submit_review_q2_pic." - ".$hrdtkpireject->nama($hrdtkpireject->submit_review_q2_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->submit_review_q2_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->approve_review_q2_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Approve Review Q2</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->approve_review_q2_pic." - ".$hrdtkpireject->nama($hrdtkpireject->approve_review_q2_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->approve_review_q2_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->reject_review_q2_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Reject Review Q2</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->reject_review_q2_pic." - ".$hrdtkpireject->nama($hrdtkpireject->reject_review_q2_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->reject_review_q2_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                    <tr>
                      <td style="width: 5%;"><b>Ket. Reject Review Q2/b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">{{ $hrdtkpireject->reject_review_q2_ket }}</td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->submit_review_q3_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Submit Review Q3</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->submit_review_q3_pic." - ".$hrdtkpireject->nama($hrdtkpireject->submit_review_q3_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->submit_review_q3_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->approve_review_q3_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Approve Review Q3</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->approve_review_q3_pic." - ".$hrdtkpireject->nama($hrdtkpireject->approve_review_q3_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->approve_review_q3_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->reject_review_q3_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Reject Review Q3</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->reject_review_q3_pic." - ".$hrdtkpireject->nama($hrdtkpireject->reject_review_q3_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->reject_review_q3_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                    <tr>
                      <td style="width: 5%;"><b>Ket. Reject Review Q3/b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">{{ $hrdtkpireject->reject_review_q3_ket }}</td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->submit_review_q4_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Submit Review Q4</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->submit_review_q4_pic." - ".$hrdtkpireject->nama($hrdtkpireject->submit_review_q4_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->submit_review_q4_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->approve_review_q4_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Approve Review Q4</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->approve_review_q4_pic." - ".$hrdtkpireject->nama($hrdtkpireject->approve_review_q4_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->approve_review_q4_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                  @endif
                  @if (!empty($hrdtkpireject->reject_review_q4_tgl))
                    <tr>
                      <td style="width: 5%;"><b>Reject Review Q4</b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">
                        {{ $hrdtkpireject->reject_review_q4_pic." - ".$hrdtkpireject->nama($hrdtkpireject->reject_review_q4_pic) }} - {{ \Carbon\Carbon::parse($hrdtkpireject->reject_review_q4_tgl)->format('d/m/Y H:i') }}
                      </td>
                    </tr>
                    <tr>
                      <td style="width: 5%;"><b>Ket. Reject Review Q4/b></td>
                      <td style="width: 1%;"><b>:</b></td>
                      <td colspan="4">{{ $hrdtkpireject->reject_review_q4_ket }}</td>
                    </tr>
                  @endif
                  <tr>
                    <td style="width: 5%;"><b>Status</b></td>
                    <td style="width: 1%;"><b>:</b></td>
                    <td style="width: 25%;">{{ $hrdtkpireject->status }}</td>
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="fp">
                <div class="box-body" id="field-fp">
                  @foreach ($hrdtkpireject->hrdtKpiActRejectByItem("FP")->get() as $model)
                            ...
                            <div class="tab-content">
                              <div role="tabpanel" class="tab-pane active" id="q1_fp_{{ $loop->iteration }}">
                                <div class="box-body">
                                  ...
                                  <!-- /.form-group -->
                                  @if ($hrdtkpireject->status === "REJECT REVIEW Q1" || $hrdtkpireject->status === "REJECT REVIEW Q2" || $hrdtkpireject->status === "REJECT REVIEW Q3" || $hrdtkpireject->status === "REJECT REVIEW Q4")
                                    <div class="row form-group">
                    ...
                    <!-- /.row -->
                  @endforeach
                  {!! Form::hidden('jml_row_fp', $hrdtkpireject->hrdtKpiActRejectByItem("FP")->get()->count(), ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'jml_row_fp']) !!}
                </div>
                <!-- /.box-body -->
                <div class="box-body">
                  <p class="pull-right">
              ...
              <div role="tabpanel" class="tab-pane" id="cs">
                <div class="box-body" id="field-cs">
                  @foreach ($hrdtkpireject->hrdtKpiActRejectByItem("CS")->get() as $model)
                    ...
                    <!-- /.row -->
                  @endforeach
                  {!! Form::hidden('jml_row_cs', $hrdtkpireject->hrdtKpiActRejectByItem("CS")->get()->count(), ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'jml_row_cs']) !!}
                </div>
                <!-- /.box-body -->
                <div class="box-body">
                  <p class="pull-right">
              ...
              <div role="tabpanel" class="tab-pane" id="ip">
                <div class="box-body" id="field-ip">
                  @foreach ($hrdtkpireject->hrdtKpiActRejectByItem("IP")->get() as $model)
                    ...
                    <!-- /.row -->
                  @endforeach
                  {!! Form::hidden('jml_row_ip', $hrdtkpireject->hrdtKpiActRejectByItem("IP")->get()->count(), ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'jml_row_ip']) !!}
                </div>
                <!-- /.box-body -->
                <div class="box-body">
                  <p class="pull-right">
              ...
              <div role="tabpanel" class="tab-pane" id="lg">
                <div class="box-body" id="field-lg">
                  @foreach ($hrdtkpireject->hrdtKpiActRejectByItem("LG")->get() as $model)
                    ...
                    <!-- /.row -->
                  @endforeach
                  {!! Form::hidden('jml_row_lg', $hrdtkpireject->hrdtKpiActRejectByItem("LG")->get()->count(), ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'jml_row_lg']) !!}
                </div>
                <!-- /.box-body -->
                <div class="box-body">
                  <p class="pull-right">
              ...
              <div role="tabpanel" class="tab-pane" id="cr">
                <div class="box-body" id="field-cr">
                  @foreach ($hrdtkpireject->hrdtKpiActRejectByItem("CR")->get() as $model)
                    ...
                    <!-- /.row -->
                  @endforeach
                  {!! Form::hidden('jml_row_cr', $hrdtkpireject->hrdtKpiActRejectByItem("CR")->get()->count(), ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'jml_row_cr']) !!}
                </div>
                <!-- /.box-body -->
                <div class="box-body">
                  <p class="pull-right">
