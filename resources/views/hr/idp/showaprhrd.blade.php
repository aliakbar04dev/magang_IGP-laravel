  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ route('hrdtidp1s.approvalhrd') }}"><i class="fa fa-files-o"></i> Daftar IDP</a></li>
      ...
      {!! Form::model($hrdtidp1, ['url' => route('hrdtidp1s.update', base64_encode($hrdtidp1->id)),
            ...
            <div class="box box-primary">
                        ...
                        @if ($hrdtidp1->hrdtIdp1Rejects()->get()->count() > 0)
                          ...
                          @foreach ($hrdtidp1->hrdtIdp1Rejects()->get() as $hrdtidp1Reject)
                            @if (Auth::user()->can(['hrd-idp-approve-hrd','hrd-idp-reject-hrd']))
                              {{ "&nbsp;-&nbsp;&nbsp;" }}<a target="_blank" href="{{ route('hrdtidp1s.showapprovalhrdrevisi', base64_encode($hrdtidp1Reject->id)) }}" data-toggle="tooltip" data-placement="top" title="Show History IDP No. Revisi {{ $hrdtidp1Reject->revisi }}">{{ $hrdtidp1Reject->revisi }}</a>
                            @else
              ...
              @if ($hrdtidp1->hrdtIdp2sByStatus("W")->get()->count() > 0)
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="box box-primary{{ !empty($hrdtidp1->id) ? ($hrdtidp1->status !== "APPROVE DIVISI" ? " collapsed-box" : "") : "" }}">
                        <div class="box-header with-border">
              ...
              @if ($hrdtidp1->hrdtIdp4s()->get()->count() > 0)
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="box box-primary{{ !empty($hrdtidp1->id) ? ($hrdtidp1->status !== "APPROVE DIVISI (MID)" ? " collapsed-box" : "") : "" }}">
                        <div class="box-header with-border">
              ...
              @if ($hrdtidp1->hrdtIdp5s()->get()->count() > 0)
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="box box-primary{{ !empty($hrdtidp1->id) ? ($hrdtidp1->status !== "APPROVE DIVISI (ONE)" ? " collapsed-box" : "") : "" }}">
                        <div class="box-header with-border">
        ...
        <div class="box-footer">
          @if ($hrdtidp1->status === "APPROVE DIVISI" || $hrdtidp1->status === "APPROVE DIVISI (MID)" || $hrdtidp1->status === "APPROVE DIVISI (ONE)")
            @if (Auth::user()->can(['hrd-idp-approve-hrd','hrd-idp-reject-hrd']))
              @if ($hrdtidp1->status === "APPROVE DIVISI")
                ...
                @if (Auth::user()->can('hrd-idp-reject-hrd'))
                  <button id='btnreject' type='button' class='btn btn-danger' data-toggle='tooltip' data-placement='top' title='Reject HRD' onclick='reject("{{ base64_encode($hrdtidp1->id) }}")'>
                    <span class='glyphicon glyphicon-remove'></span> Reject HRD
                  </button>
                  &nbsp;&nbsp;
                @endif
              @elseif ($hrdtidp1->status === "APPROVE DIVISI (MID)")
                @if (Auth::user()->can('hrd-idp-approve-hrd'))
                  {!! Form::submit('Approve HRD (MID)', ['class'=>'btn btn-primary', 'id' => 'btn-save']) !!}
                  &nbsp;&nbsp;
                @endif
                @if (Auth::user()->can('hrd-idp-reject-hrd'))
                  <button id='btnreject' type='button' class='btn btn-danger' data-toggle='tooltip' data-placement='top' title='Reject HRD (MID) IDP' onclick='reject("{{ base64_encode($hrdtidp1->id) }}")'>
                    <span class='glyphicon glyphicon-remove'></span> Reject HRD (MID)
                  </button>
                  &nbsp;&nbsp;
                @endif
              @elseif ($hrdtidp1->status === "APPROVE DIVISI (ONE)")
                @if (Auth::user()->can('hrd-idp-approve-hrd'))
                  {!! Form::submit('Approve HRD (ONE)', ['class'=>'btn btn-primary', 'id' => 'btn-save']) !!}
                  &nbsp;&nbsp;
                @endif
                @if (Auth::user()->can('hrd-idp-reject-hrd'))
                  <button id='btnreject' type='button' class='btn btn-danger' data-toggle='tooltip' data-placement='top' title='Reject HRD (ONE)' onclick='reject("{{ base64_encode($hrdtidp1->id) }}")'>
          ...
          &nbsp;&nbsp;
          <a class="btn btn-primary" href="{{ route('hrdtidp1s.approvalhrd') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Dashboard">Cancel</a>
        </div>
      {!! Form::close() !!}
    </section>
    <!-- /.content -->
