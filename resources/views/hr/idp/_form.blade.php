    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="width: 20%;">
          ...
          @else 
            {{ \Auth::user()->masKaryawan()->npk." - ".\Auth::user()->masKaryawan()->nama }}
          @endif
        </td>
        ...
        <td>
          @if (!empty($hrdtidp1->id))
            {{ $hrdtidp1->kd_gol }}
          @else 
            {{ \Auth::user()->masKaryawan()->kode_gol }}
          @endif
        </td>
      </tr>
      <tr>
        ...
        <td style="width: 20%;">
          ...
          @else 
            {{ config('app.kd_pt', 'XXX')." - ".strtoupper(config('app.nm_pt', 'XXX')) }}
          @endif
        </td>
        ...
        <td>
          ...
          @else 
            {{ \Auth::user()->masKaryawan()->kode_div." - ".\Auth::user()->masKaryawan()->desc_div }} / {{ \Auth::user()->masKaryawan()->kode_dep." - ".\Auth::user()->masKaryawan()->desc_dep }}
          @endif
        </td>
      </tr>
      <tr>
        ...
        <td style="width: 20%;">
          @if (!empty($hrdtidp1->id))
            {{ $hrdtidp1->cur_pos }}
          @else 
            {{ \Auth::user()->masKaryawan()->desc_jab }}
          @endif
        </td>
...
<div class="box-body">
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary{{ !empty($hrdtidp1->id) ? ($hrdtidp1->status !== "DRAFT" ? " collapsed-box" : "") : "" }}">
        ...
        <div class="box-body form-horizontal">
          <div class="form-group">
            <div class="col-sm-3">
              <select id="select_alc" name="select_alc" aria-controls="filter_status" class="form-control select2" onchange="changeAlc()" @if (!empty($hrdtidp1->id)) @if ($hrdtidp1->status !== "DRAFT") disabled="" @endif @endif>
            ...
            <div class="col-sm-9">
              <button id="btn-strength" type="button" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Add Strength" @if (!empty($hrdtidp1->id)) @if ($hrdtidp1->status !== "DRAFT") disabled="" @endif @endif>Add Strength</button>
              &nbsp;
              <button id="btn-weakness" type="button" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Add Development" @if (!empty($hrdtidp1->id)) @if ($hrdtidp1->status !== "DRAFT") disabled="" @endif @endif>Add Development</button>
            </div>
          </div>
          <!-- /.form-group -->
          @if (!empty($hrdtidp1->id)) 
            @if ($hrdtidp1->status === "DRAFT") 
              <div class="form-group">
                <div class="col-sm-12">
          ...
          <div class="box-body" id="field-alc-s">
            @if (!empty($hrdtidp1->id))
              @foreach ($hrdtidp1->hrdtIdp2sByStatus("S")->get() as $model)
                    ...
                    <div class="box box-primary{{ !empty($hrdtidp1->id) ? ($hrdtidp1->status !== "DRAFT" ? " collapsed-box" : "") : "" }}">
                      <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                          ...
                          @if ($hrdtidp1->status === "DRAFT" && ($hrdtidp1->npk_dep_head === \Auth::user()->username))
                ...
                <!-- /.row -->
              @endforeach
              {!! Form::hidden('jml_row_s', $hrdtidp1->hrdtIdp2sByStatus("S")->get()->count(), ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'jml_row_s']) !!}
            @else
              {!! Form::hidden('jml_row_s', 0, ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'jml_row_s']) !!}
            @endif
          </div>
        </div>
        <div class="col-md-6">
          <div class="box-body" id="field-alc-w">
            ...
            @else
              {!! Form::hidden('jml_row_w', 0, ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'jml_row_w']) !!}
            @endif
          </div>
        </div>
      </div>
                    ...
                    <div class="box box-primary{{ !empty($hrdtidp1->id) ? ($hrdtidp1->status !== "DRAFT" ? " collapsed-box" : "") : "" }}">
                      ...
                      <div class="box-body">
                        @foreach ($model->hrdtIdp3s()->get() as $hrdtIdp3)
                          @if ($hrdtidp1->status === "DRAFT" || ($hrdtidp1->status !== "DRAFT" && !empty($hrdtIdp3->program)))
                            <div class="row form-group">
                              <div class="col-sm-4">
...
@if (!empty($hrdtidp1->id))
  @if ($hrdtidp1->status === "APPROVE HRD" || $hrdtidp1->status === "APPROVE HRD (MID)")
    <div class="box-body">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary{{ !empty($hrdtidp1->id) ? ($hrdtidp1->status === "APPROVE HRD (MID)" ? " collapsed-box" : "") : "" }}">
            <div class="box-header with-border">
                      ...
                      <div class="box-body">
                        <div class="row form-group">
                          <div class="col-sm-3">
                            ...
                            @if ($hrdtidp1->status === "APPROVE HRD" && ($hrdtidp1->npk_dep_head === \Auth::user()->username))
                      ...
                      <div class="box-body">
                        <div class="row form-group">
                          <div class="col-sm-4">
                            ...
                            @if ($hrdtidp1->status === "APPROVE HRD (MID)" && ($hrdtidp1->npk_dep_head === \Auth::user()->username))
...
<div class="box-footer">
  ...
  @else
    @if ($hrdtidp1->status === "DRAFT")
      ...
      @endif
    @elseif ($hrdtidp1->status === "APPROVE HRD")
      ...
      @endif
    @elseif ($hrdtidp1->status === "APPROVE HRD (MID)")
...
<script type="text/javascript">
  ...
  $("#btn-submit").click(function(){
    ...
    if(valid_data === "F") {
      ...
      swal({
        ...
        document.getElementById("st_input").value = "DEP";
  ...
  $("#btn-delete").click(function(){
    ...
    swal({
      ...
      var urlRedirect = "{{ route('hrdtidp1s.delete', 'param') }}";
    ...
    if(jml_row > 3) {
      ...
      if(kat_alc !== "-") {
        ...
        if(double === "T") {
          ...
          var hrdt_idp2_id = 'hrdt_idp2_id_'+key+'_'+jml_row;
                ...
                <div class="box-body">\
                  <div class="row form-group">\
                    <div class="col-sm-10">\
                      ...
                      <input type="hidden" id="' + hrdt_idp2_id + '" name="' + hrdt_idp2_id + '" class="form-control" readonly="readonly" value="0">\
  ...
  function deleteKategori(ths, param) {
    if(param === "s" || param === "w") {
      ...
      swal({
        ...
        var info2 = "";
        var info3 = "warning";
        var hrdt_idp2_id = "hrdt_idp2_id_" + param + "_" + row;
        var hrdt_idp2_id_value = document.getElementById(hrdt_idp2_id).value.trim();

        if(hrdt_idp2_id_value === "0" || hrdt_idp2_id_value === "") {
          ...
          var url = "{{ route('hrdtidp2s.destroy', 'param') }}";
          url = url.replace('param', hrdt_idp2_id_value);
          $.ajax({
            type     : 'POST',
            url      : url,
            dataType : 'json',
  ...
  function changeId(param, row, database) {
    ...
    for($i = nextRow; $i <= jml_row; $i++) {
      ...
      var hrdt_idp2_id = "#hrdt_idp2_id_" + param + "_" + $i;
      var hrdt_idp2_id_new = "hrdt_idp2_id_" + param + "_" + ($i-1);
      $(hrdt_idp2_id).attr({"id":hrdt_idp2_id_new, "name":hrdt_idp2_id_new});
