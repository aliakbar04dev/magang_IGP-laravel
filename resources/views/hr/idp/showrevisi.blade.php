  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Detail History IDP <b>{{ $hrdtidp1->npk }} - {{ $hrdtidp1->tahun }}</b></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> Daftar IDP</li>
        <li class="active">Detail History IDP {{ $hrdtidp1->npk }} - {{ $hrdtidp1->tahun }}</li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Detail History IDP {{ $hrdtidp1->npk }} - {{ $hrdtidp1->tahun }}</h3>
            </div>
            <!-- /.box-header -->
      ...
      <div class="box-footer">
        <a target="_blank" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Print IDP (Revisi ke-{{ $hrdtidp1->revisi }}) {{ $hrdtidp1->npk }}" href="{{ route('hrdtidp1s.printrevisi', base64_encode($hrdtidp1->id)) }}"><span class='glyphicon glyphicon-print'></span> Print IDP (Revisi ke-{{ $hrdtidp1->revisi }})</a>
          &nbsp;&nbsp;
