...
<div class="tab-content">
  <div role="tabpanel" class="tab-pane active" id="rm">
      ...
      @foreach ($prctrfq->prctRfqRms() as $model)
        <div class="row form-group" id="rm_field_{{ $loop->iteration }}">
          <div class="col-sm-2">
            ...
            <input type="number" id="rm_no_urut_{{ $loop->iteration }}" name="rm_no_urut_{{ $loop->iteration }}" required class="form-control" placeholder="No. Urut" min="1" max="9999999999" value="{{ $model->no_urut }}">
          ...
          <div class="col-sm-5">
            ...
            <input type="text" id="rm_mat_spec_{{ $loop->iteration }}" name="rm_mat_spec_{{ $loop->iteration }}" required class="form-control" placeholder="Material Spec & Mills" maxlength="50" value="{{ $model->mat_spec }}">
          </div>
          <div class="col-sm-4">
            <label name="rm_mat_pric_period_{{ $loop->iteration }}">Material Price Period</label>
            <input type="text" id="rm_mat_pric_period_{{ $loop->iteration }}" name="rm_mat_pric_period_{{ $loop->iteration }}" class="form-control" placeholder="Material Price Period" maxlength="30" value="{{ $model->mat_pric_period }}">
          </div>
          <div class="col-sm-1">
            <label name="rm_btndelete_{{ $loop->iteration }}">Action</label>
            <button id="rm_btndelete_{{ $loop->iteration }}" name="rm_btndelete_{{ $loop->iteration }}" type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Hapus Raw Material" onclick="deleteRm(this)">
        ...
        <div class="row form-group" id="rm_field2_{{ $loop->iteration }}">
          <div class="col-sm-3">
            ...
            <input type="number" id="rm_mat_sheet_p_mm_{{ $loop->iteration }}" name="rm_mat_sheet_p_mm_{{ $loop->iteration }}" class="form-control" placeholder="Sheet (P)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->mat_sheet_p_mm) }}">
          </div>
          <div class="col-sm-3">
            <label name="rm_mat_sheet_l_mm_{{ $loop->iteration }}">Sheet (L)</label>
            <input type="number" id="rm_mat_sheet_l_mm_{{ $loop->iteration }}" name="rm_mat_sheet_l_mm_{{ $loop->iteration }}" class="form-control" placeholder="Sheet (L)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->mat_sheet_l_mm) }}">
          </div>
          <div class="col-sm-3">
            <label name="rm_mat_sheet_t_mm_{{ $loop->iteration }}">Sheet (T)</label>
            <input type="number" id="rm_mat_sheet_t_mm_{{ $loop->iteration }}" name="rm_mat_sheet_t_mm_{{ $loop->iteration }}" class="form-control" placeholder="Sheet (T)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->mat_sheet_t_mm) }}">
          </div>
          <div class="col-sm-3">
            <label name="rm_qty_per_sheet_{{ $loop->iteration }}">Qty / Sheet</label>
            <input type="number" id="rm_qty_per_sheet_{{ $loop->iteration }}" name="rm_qty_per_sheet_{{ $loop->iteration }}" class="form-control" placeholder="Qty / Sheet" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->qty_per_sheet) }}">
          </div>
        </div>
        <div class="row form-group" id="rm_field3_{{ $loop->iteration }}">
          ...
          <div class="col-sm-4">
            ...
            <input type="number" id="rm_pric_per_kg_idr_{{ $loop->iteration }}" name="rm_pric_per_kg_idr_{{ $loop->iteration }}" class="form-control" placeholder="Price / Kg (IDR)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->pric_per_kg_idr) }}">
          </div>
          <div class="col-sm-4">
        ...
        <div class="row form-group" id="rm_field4_{{ $loop->iteration }}">
          ...
          <div class="col-sm-4">
            ...
            <input type="number" id="rm_scrap_pric_per_kg_{{ $loop->iteration }}" name="rm_scrap_pric_per_kg_{{ $loop->iteration }}" class="form-control" placeholder="Scrap / Kg (IDR)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->scrap_pric_per_kg) }}">
          </div>
          <div class="col-sm-4">
    ...
    <div class="box-body">
      <p class="pull-right">
      <button id="addRowRm" type="button" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Add Raw Material"><span class="glyphicon glyphicon-plus"></span> Add Raw Material</button>
      </p>
    </div>
    <!-- /.box-body -->
    <div class="box-body">
      ...
      @foreach ($prctrfq->prctRfqProsess() as $model)
        ...
        <div class="row form-group" id="proses_field2_{{ $loop->iteration }}">
          <div class="col-sm-2">
            ...
            <input type="number" id="proses_mesin_tonage_{{ $loop->iteration }}" name="proses_mesin_tonage_{{ $loop->iteration }}" class="form-control" placeholder="Machine tonage" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->mesin_tonage) }}">
          </div>
          <div class="col-sm-2">
            <label name="proses_nil_rate_{{ $loop->iteration }}">RATE</label>
            <input type="number" id="proses_nil_rate_{{ $loop->iteration }}" name="proses_nil_rate_{{ $loop->iteration }}" class="form-control" placeholder="RATE" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->nil_rate) }}">
          </div>
          <div class="col-sm-3">
          ...
          <div class="col-sm-2">
            ...
            <input type="number" id="proses_qty_pros_{{ $loop->iteration }}" name="proses_qty_pros_{{ $loop->iteration }}" class="form-control" placeholder="QTY" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->qty_pros) }}">
          </div>
          <div class="col-sm-3">
      ...
      @foreach ($prctrfq->prctRfqTools() as $model)
        ...
        <div class="row form-group" id="tool_field2_{{ $loop->iteration }}">
          ...
          <div class="col-sm-3">
            ...
            <input type="number" id="tool_jml_depre_bln_{{ $loop->iteration }}" name="tool_jml_depre_bln_{{ $loop->iteration }}" class="form-control" placeholder="Depreciation period (month)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->jml_depre_bln) }}">
          </div>
          <div class="col-sm-2">
            <label name="tool_qty_per_bln_{{ $loop->iteration }}">QTY/ month</label>
            <input type="number" id="tool_qty_per_bln_{{ $loop->iteration }}" name="tool_qty_per_bln_{{ $loop->iteration }}" class="form-control" placeholder="QTY/ month" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->qty_per_bln) }}">
          </div>
          <div class="col-sm-4">
...
<script type="text/javascript">
  ...
  function refreshTab() {
    ...
    if(st_rm === "T") {
      ...
      document.getElementById("addRowRm").focus();
    } else if(st_proses === "T") {
  ...
  $("#addRowRm").click(function(){
    var jml_row_rm = document.getElementById("jml_row_rm").value.trim();
    jml_row_rm = Number(jml_row_rm) + 1;
    document.getElementById("jml_row_rm").value = jml_row_rm;
    
    var rm_no_rm = 'rm_no_rm_'+jml_row_rm;
    var rm_no_urut = 'rm_no_urut_'+jml_row_rm;
    var rm_mat_spec = 'rm_mat_spec_'+jml_row_rm;
    var rm_mat_pric_period = 'rm_mat_pric_period_'+jml_row_rm;
    var rm_mat_sheet_p_mm = 'rm_mat_sheet_p_mm_'+jml_row_rm;
    var rm_mat_sheet_l_mm = 'rm_mat_sheet_l_mm_'+jml_row_rm;
    var rm_mat_sheet_t_mm = 'rm_mat_sheet_t_mm_'+jml_row_rm;
    var rm_qty_per_sheet = 'rm_qty_per_sheet_'+jml_row_rm;
    var rm_nil_consump_kg = 'rm_nil_consump_kg_'+jml_row_rm;
    var rm_pric_per_kg_idr = 'rm_pric_per_kg_idr_'+jml_row_rm;
    var rm_sub_ttl = 'rm_sub_ttl_'+jml_row_rm;
    var rm_scrap_kg = 'rm_scrap_kg_'+jml_row_rm;
    var rm_scrap_pric_per_kg = 'rm_scrap_pric_per_kg_'+jml_row_rm;
    var rm_scrap_ttl_mat = 'rm_scrap_ttl_mat_'+jml_row_rm;
    var rm_btndelete = 'rm_btndelete_'+jml_row_rm;
    var rm_id_field = 'rm_field_'+jml_row_rm;
    var rm_id_field2 = 'rm_field2_'+jml_row_rm;
    var rm_id_field3 = 'rm_field3_'+jml_row_rm;
    var rm_id_field4 = 'rm_field4_'+jml_row_rm;
    var rm_id_hr = 'rm_hr_'+jml_row_rm;

    $("#field-rm").append(
      '<div class="row form-group" id="' + rm_id_field + '">\
        <div class="col-sm-2">\
          <label name="' + rm_no_urut + '">No. Urut (*)</label>\
          <input type="number" id="' + rm_no_urut + '" name="' + rm_no_urut + '" required class="form-control" placeholder="No. Urut" min="1" max="9999999999">\
          <input type="hidden" id="' + rm_no_rm + '" name="' + rm_no_rm + '" class="form-control" readonly="readonly">\
        </div>\
        <div class="col-sm-5">\
          <label name="' + rm_mat_spec + '">Material Spec & Mills (*)</label>\
          <input type="text" id="' + rm_mat_spec + '" name="' + rm_mat_spec + '" required class="form-control" placeholder="Material Spec & Mills" maxlength="50">\
        </div>\
        <div class="col-sm-4">\
          <label name="' + rm_mat_pric_period + '">Material Price Period</label>\
          <input type="text" id="' + rm_mat_pric_period + '" name="' + rm_mat_pric_period + '" class="form-control" placeholder="Material Price Period" maxlength="30">\
        </div>\
        <div class="col-sm-1">\
          <label name="' + rm_btndelete + '">Action</label>\
          <button id="' + rm_btndelete + '" name="' + rm_btndelete + '" type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Hapus Raw Material" onclick="deleteRm(this)">\
            <i class="fa fa-times"></i>\
          </button>\
        </div>\
      </div>\
      <div class="row form-group" id="' + rm_id_field2 + '">\
        <div class="col-sm-3">\
          <label name="' + rm_mat_sheet_p_mm + '">Sheet (P)</label>\
          <input type="number" id="' + rm_mat_sheet_p_mm + '" name="' + rm_mat_sheet_p_mm + '" class="form-control" placeholder="Sheet (P)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;">\
        </div>\
        <div class="col-sm-3">\
          <label name="' + rm_mat_sheet_l_mm + '">Sheet (L)</label>\
          <input type="number" id="' + rm_mat_sheet_l_mm + '" name="' + rm_mat_sheet_l_mm + '" class="form-control" placeholder="Sheet (L)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;">\
        </div>\
        <div class="col-sm-3">\
          <label name="' + rm_mat_sheet_t_mm + '">Sheet (T)</label>\
          <input type="number" id="' + rm_mat_sheet_t_mm + '" name="' + rm_mat_sheet_t_mm + '" class="form-control" placeholder="Sheet (T)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;">\
        </div>\
        <div class="col-sm-3">\
          <label name="' + rm_qty_per_sheet + '">Qty / Sheet</label>\
          <input type="number" id="' + rm_qty_per_sheet + '" name="' + rm_qty_per_sheet + '" class="form-control" placeholder="Qty / Sheet" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;">\
        </div>\
      </div>\
      <div class="row form-group" id="' + rm_id_field3 + '">\
        <div class="col-sm-4">\
          <label name="' + rm_nil_consump_kg + '">Consumption (Kg)</label>\
          <input type="text" id="' + rm_nil_consump_kg + '" name="' + rm_nil_consump_kg + '" class="form-control" placeholder="Consumption (Kg)" disabled="" style="text-align:right;">\
        </div>\
        <div class="col-sm-4">\
          <label name="' + rm_pric_per_kg_idr + '">Price / Kg (IDR)</label>\
          <input type="number" id="' + rm_pric_per_kg_idr + '" name="' + rm_pric_per_kg_idr + '" class="form-control" placeholder="Price / Kg (IDR)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;">\
        </div>\
        <div class="col-sm-4">\
          <label name="' + rm_sub_ttl + '">Total (IDR)</label>\
          <input type="text" id="' + rm_sub_ttl + '" name="' + rm_sub_ttl + '" class="form-control" placeholder="Total (IDR)" disabled="" style="text-align:right;">\
        </div>\
      </div>\
      <div class="row form-group" id="' + rm_id_field4 + '">\
        <div class="col-sm-4">\
          <label name="' + rm_scrap_kg + '">Scrap (Kg)</label>\
          <input type="text" id="' + rm_scrap_kg + '" name="' + rm_scrap_kg + '" class="form-control" placeholder="Scrap (Kg)" disabled="" style="text-align:right;">\
        </div>\
        <div class="col-sm-4">\
          <label name="' + rm_scrap_pric_per_kg + '">Scrap / Kg (IDR)</label>\
          <input type="number" id="' + rm_scrap_pric_per_kg + '" name="' + rm_scrap_pric_per_kg + '" class="form-control" placeholder="Scrap / Kg (IDR)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;">\
        </div>\
        <div class="col-sm-4">\
          <label name="' + rm_scrap_ttl_mat + '">Total (IDR)</label>\
          <input type="text" id="' + rm_scrap_ttl_mat + '" name="' + rm_scrap_ttl_mat + '" class="form-control" placeholder="Total (IDR)" disabled="" style="text-align:right;">\
        </div>\
      </div>\
      <HR id="' + rm_id_hr + '">'
    );
    document.getElementById(rm_no_urut).focus();
  });

  function changeIdRm(row) {
    var id_field = "#rm_field_" + row;
    $(id_field).remove();
    var id_field2 = "#rm_field2_" + row;
    $(id_field2).remove();
    var id_field3 = "#rm_field3_" + row;
    $(id_field3).remove();
    var id_field4 = "#rm_field4_" + row;
    $(id_field4).remove();
    var id_hr = "#rm_hr_" + row;
    $(id_hr).remove();

    var jml_row_rm = document.getElementById("jml_row_rm").value.trim();
    jml_row_rm = Number(jml_row_rm);
    nextRow = Number(row) + 1;
    for($i = nextRow; $i <= jml_row_rm; $i++) {
      var id_no_rm = "#rm_no_rm_" + $i;
      var id_no_rm_new = "rm_no_rm_" + ($i-1);
      $(id_no_rm).attr({"id":id_no_rm_new, "name":id_no_rm_new});
      var id_no_urut = "#rm_no_urut_" + $i;
      var id_no_urut_new = "rm_no_urut_" + ($i-1);
      $(id_no_urut).attr({"id":id_no_urut_new, "name":id_no_urut_new});
      var id_mat_spec = "#rm_mat_spec_" + $i;
      var id_mat_spec_new = "rm_mat_spec_" + ($i-1);
      $(id_mat_spec).attr({"id":id_mat_spec_new, "name":id_mat_spec_new});
      var id_mat_pric_period = "#rm_mat_pric_period_" + $i;
      var id_mat_pric_period_new = "rm_mat_pric_period_" + ($i-1);
      $(id_mat_pric_period).attr({"id":id_mat_pric_period_new, "name":id_mat_pric_period_new});
      var id_mat_sheet_p_mm = "#rm_mat_sheet_p_mm_" + $i;
      var id_mat_sheet_p_mm_new = "rm_mat_sheet_p_mm_" + ($i-1);
      $(id_mat_sheet_p_mm).attr({"id":id_mat_sheet_p_mm_new, "name":id_mat_sheet_p_mm_new});
      var id_mat_sheet_l_mm = "#rm_mat_sheet_l_mm_" + $i;
      var id_mat_sheet_l_mm_new = "rm_mat_sheet_l_mm_" + ($i-1);
      $(id_mat_sheet_l_mm).attr({"id":id_mat_sheet_l_mm_new, "name":id_mat_sheet_l_mm_new});
      var id_mat_sheet_t_mm = "#rm_mat_sheet_t_mm_" + $i;
      var id_mat_sheet_t_mm_new = "rm_mat_sheet_t_mm_" + ($i-1);
      $(id_mat_sheet_t_mm).attr({"id":id_mat_sheet_t_mm_new, "name":id_mat_sheet_t_mm_new});
      var id_qty_per_sheet = "#rm_qty_per_sheet_" + $i;
      var id_qty_per_sheet_new = "rm_qty_per_sheet_" + ($i-1);
      $(id_qty_per_sheet).attr({"id":id_qty_per_sheet_new, "name":id_qty_per_sheet_new});
      var id_nil_consump_kg = "#rm_nil_consump_kg_" + $i;
      var id_nil_consump_kg_new = "rm_nil_consump_kg_" + ($i-1);
      $(id_nil_consump_kg).attr({"id":id_nil_consump_kg_new, "name":id_nil_consump_kg_new});
      var id_pric_per_kg_idr = "#rm_pric_per_kg_idr_" + $i;
      var id_pric_per_kg_idr_new = "rm_pric_per_kg_idr_" + ($i-1);
      $(id_pric_per_kg_idr).attr({"id":id_pric_per_kg_idr_new, "name":id_pric_per_kg_idr_new});
      var id_sub_ttl = "#rm_sub_ttl_" + $i;
      var id_sub_ttl_new = "rm_sub_ttl_" + ($i-1);
      $(id_sub_ttl).attr({"id":id_sub_ttl_new, "name":id_sub_ttl_new});
      var id_scrap_kg = "#rm_scrap_kg_" + $i;
      var id_scrap_kg_new = "rm_scrap_kg_" + ($i-1);
      $(id_scrap_kg).attr({"id":id_scrap_kg_new, "name":id_scrap_kg_new});
      var id_scrap_pric_per_kg = "#rm_scrap_pric_per_kg_" + $i;
      var id_scrap_pric_per_kg_new = "rm_scrap_pric_per_kg_" + ($i-1);
      $(id_scrap_pric_per_kg).attr({"id":id_scrap_pric_per_kg_new, "name":id_scrap_pric_per_kg_new});
      var id_scrap_ttl_mat = "#rm_scrap_ttl_mat_" + $i;
      var id_scrap_ttl_mat_new = "rm_scrap_ttl_mat_" + ($i-1);
      $(id_scrap_ttl_mat).attr({"id":id_scrap_ttl_mat_new, "name":id_scrap_ttl_mat_new});
      var btndelete = "#rm_btndelete_" + $i;
      var btndelete_new = "rm_btndelete_" + ($i-1);
      $(btndelete).attr({"id":btndelete_new, "name":btndelete_new});
      var id_field = "#rm_field_" + $i;
      var id_field_new = "rm_field_" + ($i-1);
      $(id_field).attr({"id":id_field_new, "name":id_field_new});
      var id_field2 = "#rm_field2_" + $i;
      var id_field2_new = "rm_field2_" + ($i-1);
      $(id_field2).attr({"id":id_field2_new, "name":id_field2_new});
      var id_field3 = "#rm_field3_" + $i;
      var id_field3_new = "rm_field3_" + ($i-1);
      $(id_field3).attr({"id":id_field3_new, "name":id_field3_new});
      var id_field4 = "#rm_field4_" + $i;
      var id_field4_new = "rm_field4_" + ($i-1);
      $(id_field4).attr({"id":id_field4_new, "name":id_field4_new});
      var id_hr = "#rm_hr_" + $i;
      var id_hr_new = "rm_hr_" + ($i-1);
      $(id_hr).attr({"id":id_hr_new, "name":id_hr_new});
    }
    jml_row_rm = jml_row_rm - 1;
    document.getElementById("jml_row_rm").value = jml_row_rm;

    refreshTotal();
  }

  function deleteRm(ths) {
    var msg = 'Anda yakin menghapus Raw Material ini?';
    swal({
      title: msg,
      text: "",
      type: 'warning',
      ...
      //startcode
      var row = ths.id.replace('rm_btndelete_', '');
      var info = "";
      var info2 = "";
      var info3 = "warning";
      var no_rfq = document.getElementById("no_rfq").value.trim();
      var no_rev = document.getElementById("no_rev").value.trim();
      var no_rm = document.getElementById("rm_no_rm_" + row).value.trim();      
      if(no_rm === "") {
        changeIdRm(row);
      } else {
        //DELETE DI DATABASE
        ...
        var url = "{{ route('prctrfqs.deleterm', ['param','param2','param3']) }}";
        url = url.replace('param3', window.btoa(no_rm));
  ...
  $("#addRowProses").click(function(){
    ...
    var proses_mesin_tonage = 'proses_mesin_tonage_'+jml_row_proses;
    var proses_nil_rate = 'proses_nil_rate_'+jml_row_proses;
    var proses_pric_pros_idr = 'proses_pric_pros_idr_'+jml_row_proses;
    var proses_qty_pros = 'proses_qty_pros_'+jml_row_proses;
    ...
    $("#field-proses").append(
      ...
      <div class="row form-group" id="' + proses_id_field2 + '">\
        <div class="col-sm-2">\
          <label name="' + proses_mesin_tonage + '">Machine tonage</label>\
          <input type="number" id="' + proses_mesin_tonage + '" name="' + proses_mesin_tonage + '" class="form-control" placeholder="Machine tonage" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;">\
        </div>\
        <div class="col-sm-2">\
          <label name="' + proses_nil_rate + '">RATE</label>\
          <input type="number" id="' + proses_nil_rate + '" name="' + proses_nil_rate + '" class="form-control" placeholder="RATE" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;">\
        </div>\
        <div class="col-sm-3">\
          <label name="' + proses_pric_pros_idr + '">Price (IDR)</label>\
          <input type="text" id="' + proses_pric_pros_idr + '" name="' + proses_pric_pros_idr + '" class="form-control" placeholder="Price (IDR)" disabled="" style="text-align:right;">\
        </div>\
        <div class="col-sm-2">\
          <label name="' + proses_qty_pros + '">QTY</label>\
          <input type="number" id="' + proses_qty_pros + '" name="' + proses_qty_pros + '" class="form-control" placeholder="QTY" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;">\
        </div>\
        <div class="col-sm-3">\
  ...
  function changeIdProses(row) {
    ...
    for($i = nextRow; $i <= jml_row_proses; $i++) {
      ...
      var id_mesin_tonage = "#proses_mesin_tonage_" + $i;
      var id_mesin_tonage_new = "proses_mesin_tonage_" + ($i-1);
      $(id_mesin_tonage).attr({"id":id_mesin_tonage_new, "name":id_mesin_tonage_new});
      var id_nil_rate = "#proses_nil_rate_" + $i;
      var id_nil_rate_new = "proses_nil_rate_" + ($i-1);
      $(id_nil_rate).attr({"id":id_nil_rate_new, "name":id_nil_rate_new});
      ...
      var id_qty_pros = "#proses_qty_pros_" + $i;
      var id_qty_pros_new = "proses_qty_pros_" + ($i-1);
      $(id_qty_pros).attr({"id":id_qty_pros_new, "name":id_qty_pros_new});
  ...
  $("#addRowTool").click(function(){
    ...
    var tool_qty_per_bln = 'tool_qty_per_bln_'+jml_row_tool;
    ...
    var tool_id_field2 = 'tool_field2_'+jml_row_tool;
    ...
    $("#field-tool").append(
      ...
      <div class="row form-group" id="' + tool_id_field2 + '">\
        <div class="col-sm-3">\
        ...
        <div class="col-sm-3">\
          <label name="' + tool_jml_depre_bln + '">Depreciation period (month)</label>\
          <input type="number" id="' + tool_jml_depre_bln + '" name="' + tool_jml_depre_bln + '" class="form-control" placeholder="Depreciation period (month)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;">\
        </div>\
        <div class="col-sm-2">\
          <label name="' + tool_qty_per_bln + '">QTY/ month</label>\
          <input type="number" id="' + tool_qty_per_bln + '" name="' + tool_qty_per_bln + '" class="form-control" placeholder="QTY/ month" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;">\
        </div>\
        <div class="col-sm-4">\
  ...
  function changeIdTool(row) {
    ...
    $(id_field).remove();
    var id_field2 = "#tool_field2_" + row;
    $(id_field2).remove();
    ...
    for($i = nextRow; $i <= jml_row_tool; $i++) {
      ...
      var id_qty_per_bln = "#tool_qty_per_bln_" + $i;
      var id_qty_per_bln_new = "tool_qty_per_bln_" + ($i-1);
      $(id_qty_per_bln).attr({"id":id_qty_per_bln_new, "name":id_qty_per_bln_new});
      ...
      $(id_field).attr({"id":id_field_new, "name":id_field_new});
      var id_field2 = "#tool_field2_" + $i;
      var id_field2_new = "tool_field2_" + ($i-1);
      $(id_field2).attr({"id":id_field2_new, "name":id_field2_new});
