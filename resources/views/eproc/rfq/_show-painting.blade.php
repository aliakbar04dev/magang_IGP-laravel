      ...
      <div class="box-body">
        <div class="row form-group">
          <div class="col-sm-3 {{ $errors->has('part_weight_kg') ? ' has-error' : '' }}">
            ...
            {!! Form::number('part_weight_kg', !empty($prctrfq->part_weight_kg) ? numberFormatterForm(0, 2)->format($prctrfq->part_weight_kg) : null, ['class'=>'form-control', 'placeholder' => 'Part Weight (Kg)', 'max' => 9999999999.99, 'step' => 'any', 'id' => 'part_weight_kg', 'onchange' => 'refreshTotal()', 'style' => 'text-align:right;', 'readonly' => 'readonly']) !!}
          ...
          <div class="col-sm-3 {{ $errors->has('surf_area_mm') ? ' has-error' : '' }}">
            ...
            {!! Form::number('surf_area_mm', !empty($prctrfq->surf_area_mm) ? numberFormatterForm(0, 2)->format($prctrfq->surf_area_mm) : null, ['class'=>'form-control', 'placeholder' => 'Surface Area (mm2)', 'max' => 9999999999.99, 'step' => 'any', 'id' => 'surf_area_mm', 'onchange' => 'refreshTotal()', 'style' => 'text-align:right;', 'readonly' => 'readonly']) !!}
            ...
            @foreach ($prctrfq->prctRfqRms() as $model)
              <div class="row form-group" id="rm_field_{{ $loop->iteration }}">
                ...
                <div class="col-sm-5">
                  ...
                  <input type="text" id="rm_mat_chemical_{{ $loop->iteration }}" name="rm_mat_chemical_{{ $loop->iteration }}" required class="form-control" placeholder="Chemical Name" maxlength="50" value="{{ $model->mat_chemical }}" readonly="readonly">
                </div>
                <div class="col-sm-5">
                  <label name="rm_mat_supplier_{{ $loop->iteration }}">Supplier Name</label>
                  <input type="text" id="rm_mat_supplier_{{ $loop->iteration }}" name="rm_mat_supplier_{{ $loop->iteration }}" class="form-control" placeholder="Supplier Name" maxlength="50" value="{{ $model->mat_supplier }}" readonly="readonly">
                </div>
              </div>
              <div class="row form-group" id="rm_field2_{{ $loop->iteration }}">
                <div class="col-sm-4">
                  <label name="rm_mat_spec_{{ $loop->iteration }}">Specification</label>
                  <input type="text" id="rm_mat_spec_{{ $loop->iteration }}" name="rm_mat_spec_{{ $loop->iteration }}" class="form-control" placeholder="Specification" maxlength="50" value="{{ $model->mat_spec }}" readonly="readonly">
                </div>
                <div class="col-sm-2">
                  <label name="rm_mat_consump_kg_{{ $loop->iteration }}">Consumption (Kg)</label>
                  <input type="number" id="rm_mat_consump_kg_{{ $loop->iteration }}" name="rm_mat_consump_kg_{{ $loop->iteration }}" class="form-control" placeholder="Consumption (Kg)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->mat_consump_kg) }}" readonly="readonly">
                </div>
                <div class="col-sm-3">
            ...
            @foreach ($prctrfq->prctRfqProsess() as $model)
              <div class="row form-group" id="proses_field_{{ $loop->iteration }}">
                ...
                <div class="col-sm-2">
                  ...
                  <input type="number" id="proses_ct_proses_dtk_{{ $loop->iteration }}" name="proses_ct_proses_dtk_{{ $loop->iteration }}" class="form-control" placeholder="Cycle Time (sec)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->ct_proses_dtk) }}" readonly="readonly">
                </div>
                <div class="col-sm-2">
                  <label name="proses_pric_pros_idr_{{ $loop->iteration }}">Rate/sec (IDR)</label>
                  <input type="number" id="proses_pric_pros_idr_{{ $loop->iteration }}" name="proses_pric_pros_idr_{{ $loop->iteration }}" class="form-control" placeholder="Rate/sec (IDR)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->pric_pros_idr) }}" readonly="readonly">
                </div>
                <div class="col-sm-3">
                  <label name="proses_ttl_proses_{{ $loop->iteration }}">Total (IDR)</label>
                  <input type="text" id="proses_ttl_proses_{{ $loop->iteration }}" name="proses_ttl_proses_{{ $loop->iteration }}" class="form-control" placeholder="Total (IDR)" disabled="" style="text-align:right;" value="{{ numberFormatter(0, 2)->format($model->ttl_proses) }}" readonly="readonly">
                </div>
              </div>
              <!-- /.form-group -->
