            ...
            @foreach ($prctrfq->prctRfqProsess() as $model)
              ...
              <div class="row form-group" id="proses_field2_{{ $loop->iteration }}">
                <div class="col-sm-5">
                  ...
                  <input type="text" id="proses_mesin_type_{{ $loop->iteration }}" name="proses_mesin_type_{{ $loop->iteration }}" class="form-control" placeholder="Machine Type/ Spec" maxlength="50" value="{{ $model->mesin_type }}" readonly="readonly">
                </div>
                <div class="col-sm-3">
                  <label name="proses_pric_pros_idr_{{ $loop->iteration }}">Rate (IDR)</label>
                  <input type="number" id="proses_pric_pros_idr_{{ $loop->iteration }}" name="proses_pric_pros_idr_{{ $loop->iteration }}" class="form-control" placeholder="Rate (IDR)" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->pric_pros_idr) }}" readonly="readonly">
                </div>
                <div class="col-sm-4">
            ...
            @foreach ($prctrfq->prctRfqTools() as $model)
              <div class="row form-group" id="tool_field_{{ $loop->iteration }}">
                ...
                <div class="col-sm-2">
                  ...
                  <input type="number" id="tool_jml_depre_bln_{{ $loop->iteration }}" name="tool_jml_depre_bln_{{ $loop->iteration }}" class="form-control" placeholder="Depreciation" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->jml_depre_bln) }}" readonly="readonly">
                </div>
                <div class="col-sm-2">
