...
{!! Form::open(['url'=>'/admin/aprovalDeptSetujui' , 'class'=>'form-horizontal', 'onsubmit'=>"return confirm('Anda Yakin Ingin Menyetujui $pistandard->no_pis ?');", 'style' =>'display:inline;']) !!}
<input type="hidden" name="no_pis" value="{{ $pistandard->no_pis }}">
