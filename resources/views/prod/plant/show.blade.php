  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Detail {{ $prodnpk->npk }}</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box-footer">
        @if (Auth::user()->can('prod-plant-create'))
          <a class="btn btn-primary" href="{{ route('prodnpks.edit', base64_encode($prodnpk->npk)) }}" data-toggle="tooltip" data-placement="top" title="Ubah Data">Ubah Data</a>
          &nbsp;&nbsp;
        @endif
        @if (Auth::user()->can('prod-plant-delete'))
          ...
          &nbsp;&nbsp;
        @endif
        <a class="btn btn-primary" href="{{ route('prodnpks.index') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Dashboard NPK/Plant" id="btn-cancel">Cancel</a>
      </div>
    </section>
    <!-- /.content -->
  </div>
...
<script type="text/javascript">
  $("#btn-delete").click(function(){
    ...
    swal({
      ...
      var urlRedirect = "{{ route('prodnpks.delete', 'param') }}";
