  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Update BPB CR Consumable Ireguler</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Update BPB CR Consumable Ireguler</h3>
        </div>
        <!-- /.box-header -->
        
        <!-- form start -->
        {!! Form::model($whstconscr01, ['url' => route('bpbcrconsireg.update', base64_encode($whstconscr01->no_doc)),
