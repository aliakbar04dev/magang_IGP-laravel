...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">BPB CR Consumable Reguler</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">BPB CR Consumable Reguler</h3>
      </div>
      <!-- /.box-header -->
      ...
      <div class="box-body form-horizontal"> 
        ...
        <p>
          <a class="btn btn-primary" href="{{ route('bpbcrcons.create') }}"><span class="fa fa-plus"></span> Add BPB</a>
        </p>
        @endpermission
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var url = '{{ route('bpbcrcons.dashboard') }}';
