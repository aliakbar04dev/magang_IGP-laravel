...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        DEPR
        <small>DEPR Approval DEP</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> PPC - Transaksi</li>
        <li class="active"><i class="fa fa-files-o"></i> DEPR Approval DEP</li>
      </ol>
    </section>
          ...
          <div class="box box-primary">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  ...
                  <select size="1" id="status" name="status" class="form-control select2">
                    ...
                    <option value="3" selected="selected">Approve Section</option>
            ...
            @permission(['ppc-dpr-apr-dh'])
              <div class="box-footer">
                <button id="btnapprove" type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Approve DEP DEPR">
                  <span class="glyphicon glyphicon-check"></span> Approve DEP DEPR
                </button>
                <button id="btnreject" type="button" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Reject DEP DEPR">
                  <span class="glyphicon glyphicon-remove"></span> Reject DEP DEPR
                </button>
              </div>
              <!-- /.box -->
            @endpermission
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var url = '{{ route('dashboarddep.ppctdprs') }}';
    ...
    $('#btnapprove').click( function () {
      ...
      if(validasi === "T") {
        ...
        swal({
          title: 'Anda yakin Approve DEP DEPR tsb?',
    ...
    $('#btnreject').click( function () {
      ...
      if(validasi === "T") {
        //additional input validations can be done hear
        swal({
          title: 'Anda yakin Reject DEP DEPR tsb?',
          text: 'Jumlah DEPR: ' + jmldata,
          type: 'question',
          showCancelButton: true,
          confirmButtonColor: '#3085d6',
