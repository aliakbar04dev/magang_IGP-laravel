...
<div class="panel panel-default">
               ...
               <table class="table table-bordered" style="width: 1000%;height:190px;">
                 <tr>
                   <td colspan="12" style="width: 1000px;">
                      <center>
                      {!! Form::file('logo_supplier', ['style' => 'border: 1px solid #ccc; margin: 0; position: absolute; top: 5px;']) !!}
        ...
        <div class="form-group">
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('no_doc') ? ' has-error' : '' }}">
              ...
              {!! Form::text('nama_supplier', null, ['class'=>'form-control', 'min'=>1, ]) !!}
          ...
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('no_doc') ? ' has-error' : '' }}">
              ...
              <div class="input-group">
                ...
                @if(!empty($pistandards->date_issue)) 
                {!! Form::date('date_issue', \Carbon\Carbon::parse($pistandards->date_issue), ['class'=>'form-control js-selectize']) !!}
                @else 
        ...
        <div class="form-group">
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('no_doc') ? ' has-error' : '' }}">
              ...
              {!! Form::text('model', null, ['class'=>'form-control', 'min'=>1, ]) !!}
              ...
              @if($pistandards->general_tol == '' || $pistandards->general_tol == '[""]' || $pistandards->general_tol == null )
               {!! Form::text('general_tol[]',null, ['class'=>'form-control',]) !!}
                ...
                @foreach(json_decode($pistandards->general_tol) as $key => $value)
                  {!! Form::text('general_tol[]',$value, ['class'=>'form-control',]) !!}
                @endforeach
              @endif
              {!! $errors->first('material', '<p class="help-block">:message</p>') !!}
            </div>
        ...
        <div class="form-group"  id="">
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('creaby') ? ' has-error' : '' }}">
              ...
              <div class="input-group ">
                 {!! Form::textarea('c_logosupplier', null, ['class'=>'form-control', 'readonly' => 'readonly', 'style' => 'width : 485px']) !!}
        ...
        <div class="form-group"  id="">
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('creaby') ? ' has-error' : '' }}">
              ...
              <div class="input-group ">
                {!! Form::text('c_nopis', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                <span class="input-group-btn">
        ...
        <div class="form-group"  id="">
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('creaby') ? ' has-error' : '' }}">
              ...
              <div class="input-group ">
                {!! Form::text('c_supname', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                 <span class="input-group-btn">
        ...
        <div class="form-group"  id="">
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('creaby') ? ' has-error' : '' }}">
              ...
              <div class="input-group ">
                {!! Form::text('c_dateissue', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                 <span class="input-group-btn">
        ...
        <div class="form-group"  id="">
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('creaby') ? ' has-error' : '' }}">
              ...
              <div class="input-group ">
                {!! Form::text('c_model', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                <span class="input-group-btn">
        ...
        <div class="form-group"  id="">
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('creaby') ? ' has-error' : '' }}">
              ...
              <div class="input-group ">
                {!! Form::text('c_refno', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                <span class="input-group-btn">
        ...
        <div class="form-group"  id="">
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('creaby') ? ' has-error' : '' }}">
              ...
              <div class="input-group ">
                {!! Form::text('c_material', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                <span class="input-group-btn">
            ...
            <div class="col-sm-12">
               <div class="col-sm-12 {{ $errors->has('creaby') ? ' has-error' : '' }}">
                 ...
                 <div class="input-group ">
                   ...
                   {!! Form::text('c_generaltol[]',null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                   ...
                   @elseif($pistandards->c_generaltol !== ''|| $pistandards->c_generaltol !== null || $pistandards->c_generaltol !== '[""]')
                     ...
                     @foreach(json_decode($pistandards->c_generaltol) as $key => $nilai)
                        {!! Form::text('c_generaltol[]',$nilai, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                     @endforeach
        ...
        <div class="form-group"  id="">
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('creaby') ? ' has-error' : '' }}">
              ...
              <div class="input-group ">
                {!! Form::text('c_weight', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                 <span class="input-group-btn">
        ...
        <div class="form-group"  id="">
            <div class="col-sm-12">
              ...
              {!! Form::label('c_partno', 'PART NO') !!}
                <div class="input-group ">
                  {!! Form::text('c_partno', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                  <span class="input-group-btn">
        ...
        <div class="form-group"  id="">
            <div class="col-sm-12">
              <div class="col-sm-12 {{ $errors->has('creaby') ? ' has-error' : '' }}">
                ...
                <div class="input-group ">
                  {!! Form::text('c_partname', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                  <span class="input-group-btn">
        ...
        <div class="form-group"  id="">
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('creaby') ? ' has-error' : '' }}">
              ...
              <div class="input-group ">
                {!! Form::text('c_stat_doc', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                 <span class="input-group-btn">
        ...
        <div class="form-group"  id="">
          <div class="col-sm-12">
            <div class="col-sm-12 {{ $errors->has('creaby') ? ' has-error' : '' }}">
              ...
              <div class="input-group ">
                {!! Form::text('c_supp_dept', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                   ...
                   <div  style="overflow:auto;width:auto; height:200px;margin:bottom 200px;">
                     ...
                     <table class="table table-bordered"  style="width: 1800px;">
                       ...
                       @if (!empty($composition->no_pisigp))
                         @foreach ($entity->getLines($composition->no_pisigp, $composition->norev)->get() as $model)
                           <tr id="">
                             <div class="">
                               <div class=""> 
                                 <td>
                           ...
                           <tr id="id_linehidden_{{ $loop->iteration }}">
                             <div class="">
                               <div class=""> 
                                 ...
                                 <td>
                                   <div class="input-group">
                                     <input type="text" id="a_item_{{ $loop->iteration }}" name="a_item_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $test->a_item }}" />
                                 ...
                                 <td>
                                   <div class="input-group">
                                     <input type="text" id="a_nominal_{{ $loop->iteration }}" name="a_nominal_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->a_nominal }}"/>
                                   </div>
                                 </td>

                                 <td>
                                   <input type="text" id="a_tolerance_{{ $loop->iteration }}" name="a_tolerance_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->a_tolerance }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="a_instrument_{{ $loop->iteration }}" name="a_instrument_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->a_instrument }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="a_rank_{{ $loop->iteration }}" name="a_rank_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->a_rank }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="a_proses_{{ $loop->iteration }}" name="a_proses_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->a_proses }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="a_delivery_{{ $loop->iteration }}" name="a_delivery_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->a_delivery }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="a_remarks_{{ $loop->iteration }}" name="a_remarks_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->a_remarks }}"/>
                                 </td>
                ...
                <div  style="overflow:auto;width:auto; height:200px;margin:bottom 200px;">
                  ...
                  <table class="table table-bordered"  style="width: 1800px;">
                    ...
                    @if (!empty($properties->no_pisigp))
                        ...
                        @else
                        {!! Form::hidden('linehidden1', 0, ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'linehidden1']) !!}
                    @endif
                  </table>
                </div>
            </div>
                        ...
                        <tr id="id_linehidden1_{{ $loop->iteration }}">
                          <div class="">
                            <div class=""> 
                              ...
                              <td>
                                <div class="input-group">
                                  <input type="text" id="b_item_{{ $loop->iteration }}" name="b_item_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->b_item }}" />
                                </div>
                              </td>

                              <td>
                                <div class="input-group">
                                  <input type="text" id="b_nominal_{{ $loop->iteration }}" name="b_nominal_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->b_nominal }}"/>
                                </div> 
                              </td>

                              <td>
                                <input type="text" id="b_tolerance_{{ $loop->iteration }}" name="b_tolerance_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->b_tolerance }}"/>
                              </td>

                              <td>
                                <input type="text" id="b_instrument_{{ $loop->iteration }}" name="b_instrument_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->b_instrument }}"/>
                              </td>

                              <td>
                                <input type="text" id="b_rank_{{ $loop->iteration }}" name="b_rank_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->b_rank }}"/>
                              </td>

                              <td>
                                <input type="text" id="b_proses_{{ $loop->iteration }}" name="b_proses_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->b_proses }}"/>
                              </td>

                              <td>
                                <input type="text" id="b_delivery_{{ $loop->iteration }}" name="b_delivery_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->b_delivery }}"/>
                              </td>

                              <td>
                                <input type="text" id="b_remarks_{{ $loop->iteration }}" name="b_remarks_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->b_remarks }}"/>
                              </td>
                ...
                <div  style="overflow:auto;width:auto; height:200px;margin:bottom 200px;">
                  ...
                  <table class="table table-bordered"  style="width: 1800px;">
                    ...
                    @if (!empty($performances->no_pisigp))
                        ...
                        @else
                         {!! Form::hidden('linehidden2', 0, ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'linehidden2']) !!}
                    @endif
                  </table>
                </div>
            </div>
                          ...
                          <tr id="">
                            <div class="">
                              <div class=""> 
                                ...
                                <td>
                                  <div class="input-group">
                                  <input type="text" id="c_item_{{ $loop->iteration }}" name="c_item_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true"  value="{{ $model->c_item }}" />
                                  </div>
                                </td>

                                <td>
                                  <div class="input-group">
                                    <input type="text" id="c_nominal_{{ $loop->iteration }}" name="c_nominal_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->c_nominal }}"/>
                                  </div>
                                </td>

                                <td>
                                  <input type="text" id="c_tolerance_{{ $loop->iteration }}" name="c_tolerance_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->c_tolerance }}"/>
                                </td>

                                <td>
                                  <input type="text" id="c_instrument_{{ $loop->iteration }}" name="c_instrument_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->c_instrument }}"/>
                                </td>

                                <td>
                                  <input type="text" id="c_rank_{{ $loop->iteration }}" name="c_rank_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->c_rank }}"/>
                                </td>

                                <td>
                                  <input type="text" id="c_proses_{{ $loop->iteration }}" name="c_proses_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->c_proses }}"/>
                                </td>

                                <td>
                                  <input type="text" id="c_delivery_{{ $loop->iteration }}" name="c_delivery_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->c_delivery }}"/>
                                </td>

                                <td>
                                  <input type="text" id="c_remarks_{{ $loop->iteration }}" name="c_remarks_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->c_remarks }}"/>
                                </td>
               ...
               <div  style="overflow:auto;width:auto; height:200px;margin:bottom 200px;">
                 ...
                 <table class="table table-bordered"  style="width: 1800px;">
                   ...
                   @if (!empty($treatements->no_pisigp))
                       ...
                       @else
                        {!! Form::hidden('linehidden3', 0, ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'linehidden3']) !!}
                   @endif
                 </table>
               </div>
           </div>
                         ...
                         <tr id="">
                           <div class="">
                             <div class=""> 
                               ...
                               <td>
                                 <div class="input-group">
                                 <input type="text" id="d_item_{{ $loop->iteration }}" name="d_item_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->d_item }}" />
                                 </div>
                               </td>

                               <td>
                                 <div class="input-group">
                                   <input type="text" id="d_nominal_{{ $loop->iteration }}" name="d_nominal_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->d_nominal }}"/>
                                 </div>
                               </td>

                               <td>
                                 <input type="text" id="d_tolerance_{{ $loop->iteration }}" name="d_tolerance_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->d_tolerance }}"/>
                               </td>

                               <td>
                                 <input type="text" id="d_instrument_{{ $loop->iteration }}" name="d_instrument_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->d_instrument }}"/>
                               </td>

                               <td>
                                 <input type="text" id="d_rank_{{ $loop->iteration }}" name="d_rank_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->d_rank }}"/>
                               </td>

                               <td>
                                 <input type="text" id="d_proses_{{ $loop->iteration }}" name="d_proses_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->d_proses }}"/>
                               </td>

                               <td>
                                 <input type="text" id="d_delivery_{{ $loop->iteration }}" name="d_delivery_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->d_delivery }}"/>
                               </td>

                               <td>
                                 <input type="text" id="d_remarks_{{ $loop->iteration }}" name="d_remarks_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->d_remarks }}"/>
                               </td>
                  ...
                  <table class="table table-bordered"  style="width: 1800px;">
                   ...
                   @if (!empty($htreatements->no_pisigp))
                      @foreach ($entity->getLines4($htreatements->no_pisigp)->get() as $model)
                        ...
                        @else
                         {!! Form::hidden('linehidden4', 0, ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'linehidden4']) !!}
                    @endif
                  </table>
                </div>
            </div>
                          ...
                          <tr id="">
                            <div class="">
                              <div class=""> 
                                ...
                                <td>
                                  <div class="input-group">
                                  <input type="text" id="e_item_{{ $loop->iteration }}" name="e_item_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->e_item }}" />
                                  </div>
                                </td>

                                <td>
                                  <div class="input-group">
                                    <input type="text" id="e_nominal_{{ $loop->iteration }}" name="e_nominal_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->e_nominal }}"/>
                                  </div>
                                </td>

                                <td>
                                  <input type="text" id="e_tolerance_{{ $loop->iteration }}" name="e_tolerance_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->e_tolerance }}"/>
                                </td>

                                <td>
                                  <input type="text" id="e_instrument_{{ $loop->iteration }}" name="e_instrument_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->e_instrument }}"/>
                                </td>

                                <td>
                                  <input type="text" id="e_rank_{{ $loop->iteration }}" name="e_rank_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->e_rank }}"/>
                                </td>

                                <td>
                                  <input type="text" id="e_proses_{{ $loop->iteration }}" name="e_proses_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->e_proses }}"/>
                                </td>

                                <td>
                                  <input type="text" id="e_delivery_{{ $loop->iteration }}" name="e_delivery_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->e_delivery }}"/>
                                </td>

                                <td>
                                  <input type="text" id="e_remarks_{{ $loop->iteration }}" name="e_remarks_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->e_remarks }}"/>
                                </td>
                   ...
                   <table class="table table-bordered"  style="width: 1800px;">
                     ...
                     @if (!empty($appearences->no_pisigp))
                        @foreach ($entity->getLines5($appearences->no_pisigp)->get() as $model)   
                         ...
                         @else
                          {!! Form::hidden('linehidden5', 0, ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'linehidden5']) !!}
                     @endif
                   </table>
                 </div>
             </div>
                             ...
                             <div class="">
                               <div class=""> 
                                <td>
                                 ...
                                 <td>
                                   <div class="input-group">
                                   <input type="text" id="f_item_{{ $loop->iteration }}" name="f_item_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->f_item }}" />
                                   </div>
                                 </td>

                                 <td>
                                   <div class="input-group">
                                     <input type="text" id="f_nominal_{{ $loop->iteration }}" name="f_nominal_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->f_nominal }}"/>
                                   </div>
                                 </td>

                                 <td>
                                   <input type="text" id="f_tolerance_{{ $loop->iteration }}" name="f_tolerance_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->f_tolerance }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="f_instrument_{{ $loop->iteration }}" name="f_instrument_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->f_instrument }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="f_rank_{{ $loop->iteration }}" name="f_rank_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->f_rank }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="f_proses_{{ $loop->iteration }}" name="f_proses_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->f_proses }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="f_delivery_{{ $loop->iteration }}" name="f_delivery_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->f_delivery }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="f_remarks_{{ $loop->iteration }}" name="f_remarks_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->f_remarks }}"/>
                                 </td>
                    ...
                    <table class="table table-bordered"  style="width: 1800px;">
                      ...
                      @if (!empty($dimentions->no_pisigp))
                         @foreach ($entity->getLines6($dimentions->no_pisigp)->get() as $model)
                          ...
                          @else
                           {!! Form::hidden('linehidden6', 0, ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'linehidden6']) !!}
                      @endif
                    </table>
                  </div>
              </div>
                            ...
                            <tr id="">
                              <div class="">
                                ...
                                <td>
                                  ...
                                  <td>
                                    <div class="input-group">
                                    <input type="text" id="g_item_{{ $loop->iteration }}" name="g_item_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->g_item }}" />
                                    </div>
                                  </td>

                                  <td>
                                    <div class="input-group">
                                      <input type="text" id="g_nominal_{{ $loop->iteration }}" name="g_nominal_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->g_nominal }}"/>
                                    </div>
                                  </td>

                                  <td>
                                    <input type="text" id="g_tolerance_{{ $loop->iteration }}" name="g_tolerance_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->g_tolerance }}"/>
                                  </td>

                                  <td>
                                    <input type="text" id="g_instrument_{{ $loop->iteration }}" name="g_instrument_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->g_instrument }}"/>
                                  </td>

                                  <td>
                                    <input type="text" id="g_rank_{{ $loop->iteration }}" name="g_rank_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->g_rank }}"/>
                                  </td>

                                  <td>
                                    <input type="text" id="g_proses_{{ $loop->iteration }}" name="g_proses_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->g_proses }}"/>
                                  </td>

                                  <td>
                                    <input type="text" id="g_delivery_{{ $loop->iteration }}" name="g_delivery_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->g_delivery }}"/>
                                  </td>

                                  <td>
                                    <input type="text" id="g_remarks_{{ $loop->iteration }}" name="g_remarks_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->g_remarks }}"/>
                                  </td>
                   ...
                   <div  style="overflow:auto;width:auto; height:200px;margin:bottom 200px;">
                    ...
                    <table class="table table-bordered" style="width: 1000px;">
                       ...
                       {!! Form::hidden('linehidden7', $entity->getLines7($socfs->no_pisigp)->get()->count(), ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'linehidden7']) !!}
                           @else
                            {!! Form::hidden('linehidden7', 0, ['class'=>'form-control', 'readonly'=>'readonly', 'id' => 'linehidden7']) !!}
                       @endif 
                     </table>
                   </div>
               </div>
                           ...
                           @foreach ($entity->getLines7($socfs->no_pisigp)->get() as $model)
                             <tr id="">
                               <div class="">
                                 ...
                                 <td>
                                   <div class="input-group">
                                     <input type="text" id="h_item_{{ $loop->iteration }}" name="h_item_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->h_item }}" />

                                   </div>
                                 </td>

                                 <td>
                                   <input type="text" id="h_instrument_{{ $loop->iteration }}" name="h_instrument_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->h_instrument }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="h_rank_{{ $loop->iteration }}" name="h_rank_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->h_rank }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="h_proses_{{ $loop->iteration }}" name="h_proses_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->h_proses }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="h_delivery_{{ $loop->iteration }}" name="h_delivery_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->h_delivery }}"/>
                                 </td>

                                 <td>
                                   <input type="text" id="h_remarks_{{ $loop->iteration }}" name="h_remarks_{{ $loop->iteration }}" placeholder="" class="form-control name_list" readonly="true" value="{{ $model->h_remarks }}"/>
                                 </td>
            ...
            <div class="col-md-12">
             {{-- ========= --}}
                        ...
                        <table  cellspacing="0" cellpadding="0" width="100%">
                          <tr>
                            <td colspan="12" height="250" >
                              <center>
                               {!! Form::file('part_routing', ['style' => 'border: 1px solid #ccc; margin: 0; position: absolute; top: 57px;']) !!}
              ...
              <div class="box-body col-md-12">
                  ...
                  <div  style="">
                      <!-- /.Table Input-->
                    {!! Form::textarea('c_partrouting', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                  </div>
           ...
           <div class="col-md-12">
            {{-- Gambar--}}
                      ...
                      <td colspan="12">
                       <table  cellspacing="0" cellpadding="0" width="100%">
                         <tr>
                           <td colspan="12" height="250" >
                             <center>
                             {!! Form::file('sketchdrawing', ['style' => 'border: 1px solid #ccc; margin: 0; position: absolute; top: 57px;']) !!}
             ...
             <div class="box-body col-md-12">
                 ...
                 <div  style="">
                     <!-- /.Table Input-->
                   {!! Form::textarea('c_skecthdrawing', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                 </div>
           ...
           <div class="col-md-12">
            {{-- ========= --}}
                      ...
                      <td colspan="12">
                       <table  cellspacing="0" cellpadding="0" width="100%">
                         <tr>
                           <td colspan="12" height="250" >
                             <center>
                             {!! Form::file('sketchmmethode', ['style' => 'border: 1px solid #ccc; margin: 0; position: absolute; top: 57px;']) !!}
             ...
             <div class="box-body col-md-12">
                 ...
                 <div  style="">
                     <!-- /.Table Input-->
                   {!! Form::textarea('c_sketchmethod', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                 </div>
             </div>
           </div>
         </div>
           ...
           <div class="col-md-12">
            {{-- ========= --}}
                       ...
                       <table  cellspacing="0" cellpadding="0" width="100%">
                         <tr>
                           <td colspan="12" height="250px" > 
                             <center>
                               {!! Form::file('sketchappearance', ['style' => 'border: 1px solid #ccc; margin: 0; position: absolute; top: 57px;']) !!}
             ...
             <div class="box-body col-md-12">
                 ...
                 <div  style="">
                     <!-- /.Table Input-->
                   {!! Form::textarea('c_sketchappearence', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
                 </div>
             </div>
           </div>
         </div>
  ...
  <div class="panel-body" >
   <div class="box box-primary">
     {{-- UPLOAD ELECTRONIC SIGN --}}
     {!! Form::hidden('no_pisigp', null, ['class'=>'form-control']) !!}
     {!! Form::hidden('norev', null, ['class'=>'form-control']) !!}
     {!! Form::hidden('submit', null, ['class'=>'form-control']) !!}
     <div class="panel-heading" style="background-color: #DD4B39">
 ...
 <div class="box-body" >
  ...
  <div class="box-body" >
   ...
   <div class="box-footer col-md-12">
       @if($pistandards->status == 3)
         <button type="submit" name="post" value="savekuy" class="btn btn-success">Submit</button>
         &nbsp;&nbsp;
         &nbsp;&nbsp;
         <button type="submit" name="post" value="draftkuy" class="btn btn-primary">Save Draft</button>
       @endif
       &nbsp;&nbsp;
       &nbsp;&nbsp;
       <a class="btn btn-danger" href="{{ route('pistandards.index') }}" data-toggle="tooltip" data-placement="top" title="" id="btn-cancel">Back</a>
        &nbsp;&nbsp;
   </div>
</div>
