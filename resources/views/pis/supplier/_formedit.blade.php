	...
	<div class="box-body" >
		<div class="col-md-12">
			...
			<div class="box-body col-md-6">
				...
				<div class="col-sm-12">
					...
					<div class="input-group">
						...
						{!! Form::text('nama_supplier', null, ['class'=>'form-control', 'readonly' => 'readonly']) !!}
			...
			<div class="box-body col-md-6">
				...
				<div class="col-sm-12 " id="id_field">
					{!! Form::label('GENERAL TOL:', '') !!}
					<div class="input-group" >
						<span class="input-group-addon"><i class="fa fa-pencil"></i></span>
						@if($pistandard->general_tol !== '')
						@foreach(json_decode($pistandard->general_tol) as $key => $value)
						<input type="text"  id="general_tol_" name="general_tol[]"  class="form-control"  maxlength="30" value="{{$value}}" >
						@endforeach
						...
						@endif
						{{--  @if($pistandard->general_tol == '' || $pistandard->general_tol == '[""]' || $pistandard->general_tol !== null )
			               {!! Form::text('general_tol[]',null, ['class'=>'form-control',]) !!}
			                ...
			                @elseif($pistandard->general_tol !== '[""]' || $pistandard->general_tol !== '' || $pistandard->general_tol !== null )
			                @foreach(json_decode($pistandard->general_tol) as $key => $value)
										...
										<table  cellspacing="0" cellpadding="0" width="100%">
											<tr>
												<td colspan="12" height="250" style="border: 1px solid #ccc; margin: 0;">
													...
													<img src="{{ $part_routing }}"   width="50%" height="80%">
													@else()
													<img src="/images/no_image.png" width="50" height="80%">				
													@endif
												</td>
											</tr>
										</table>
				...
				<div class="col-md-12">
					...
					<div class="box-body col-md-12" >
						...
						<div  style="">
							...
							<img src="{{ $staff_spy }}" alt="File Not Found" class="img-rounded img-responsive" width="100px" height="100px">
							@else()
							<img src="images/no_image.png" width="10px" border="0">
							@endif
							{!! Form::text('staff_name', null,  ['class'=>'','placeholder' => 'Nama Lengkap']) !!}
						</div>
					</div>
					{{-- Catatan --}}
				...
				<div class="col-md-12">
					...
					<div class="box-body col-md-12" >
						...
						<div  style="">
							...
							<img src="{{ $supervisor_spy }}" alt="File Not Found" class="img-rounded img-responsive" width="100px" height="100px">
							@else()
							<img src="/images/no_image.png" width="50%" height="50%">						
							@endif
							{!! Form::text('supervisor_name', null,  ['class'=>'','placeholder' => 'Nama Lengkap']) !!}
						</div>
					</div>
					{{-- ====================================== --}}
				...
				<div class="col-md-12">
					...
					<div class="box-body col-md-12" >
						...
						<div  style="">
							...
							<img src="{{ $manager_spy }}" alt="File Not Found" class="img-rounded img-responsive" width="100px" height="100px">
							@else()
							<img src="/images/no_image.png" width="50" height="50%">
							@endif	
							{!! Form::text('manager_name', null,  ['class'=>'','placeholder' => 'Nama Lengkap']) !!} 
						</div>
					</div>
					{{-- ====================================== --}}
...
<script type="text/javascript">
	...
	// $("table#id_field").on("click",".buttonDel", function (event){
	// 	$(this).closest("tr").remove();
	// 	jml_general = jml_general - 1;
	// 	document.getElementById("jml_general").value = jml_general;
