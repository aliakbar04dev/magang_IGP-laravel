  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <!-- form start -->
        {!! Form::model($pistandards, ['url' => route('pisstaff.update', [base64_decode($pistandards->no_pisigp),base64_decode($pistandards->norev)]),
            'method'=>'post', 'role'=>'form', 'files'=>'true','id'=>'form_id']) !!}
          @include('pis.staff._upload')
        {!! Form::close() !!}
      </div>
      <!-- /.box -->
    </section>
