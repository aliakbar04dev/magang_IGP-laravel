...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><i class="fa fa-files-o"></i>PART INSPECTION STANDARD (PIS)</li>
    </ol>
  </section>
  <!-- Main content -->
            ...
            <div class="box-body col-md-12">
              <div class="col-sm-12">
                <div class="box-header" center>
                  <div class="btn-group">
                   <a class="btn btn-primary" href="{{route('pistandards.dafrev') }}">Data Revisi</a>
                  </div>
                </div>
              </div>
          </div>
...
<script type="text/javascript">
  $(function() {
    ...
    {data: 'rev_doc', name: 'rev_doc', searchable:true},
