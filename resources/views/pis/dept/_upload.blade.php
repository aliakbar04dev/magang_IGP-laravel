          ...
          <div class="form-group"  id="">
            <div class="col-sm-12">
              <div class="col-sm-12">
                ...
                {!! $errors->first('c_logosupplier', '<p class="help-block">:message</p>') !!}
              </div>
            </div>
          </div>
          <!-- /.PIS NO -->
  ...
  <div class="panel-body" >
        ...
        <div class="panel-body col-md-12">
          <div class="box-body" >
            <div class="col-md-12">
             {{-- ========= --}}
              <div class="form-group">
                {!! Form::label('approve_dept ', 'UPLOAD TTD', ['class'=>'col-md-2 control-label']) !!}
                <div class="col-md-4">
                     {!! Form::file('approve_dept') !!}
                     {!! $errors->first('approve_dept', '<p class="help-block">:message</p>') !!}
                </div>
              </div>
               ...
               <div class="form-group">
                 <div class="col-md-2">
                   {!! Form::label('notesect', 'NAMA', ['class'=>'col-md-2 control-label']) !!}
                 </div>
                 <div class="col-md-4">
                   {!! Form::text('igpdept_nm', null, ['class'=>'form-control']) !!}
                 </div>
               </div>
   ...
   <div class="box-footer col-md-12">
      <form action="{{ url('update') }}" method="POST">
        <!-- fields -->
        <button type="submit" name="action" value="save" class="btn btn-success" onsubmit="return confirm('Anda Yakin Ingin Menyetujui $pistandard->no_pis ?');", style ='display:inline;' data-toggle="tooltip" data-placement="top" title="SEND TO SUPPLIER APPROVED DOCUMENT" class="btn btn-success "><i class="fa fa-check"></i></button>
        &nbsp;&nbsp;
        &nbsp;&nbsp;

        <button type="submit" name="action" value="save_draft"  onsubmit="return confirm('Anda Yakin Ingin Mereject $pistandard->no_pis ?');", style ='display:inline;' data-toggle="tooltip" data-placement="top" title="SEND TO SUPPLIER NOT APPROVED WITH NOTES" class="btn btn-danger"><i class="fa fa-remove"></i></button>
        &nbsp;&nbsp;
        &nbsp;&nbsp;
