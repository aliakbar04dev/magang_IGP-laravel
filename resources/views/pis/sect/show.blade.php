...
<div class="box-footer">
   <a class="btn btn-primary" href="{{route('pissecthead.edit',[base64_encode($pistandards->no_pisigp),base64_encode($pistandards->norev)])}}" data-toggle="tooltip" data-placement="top" title="Next To Upload Electronic Sign/Note ">Next</a>
    &nbsp;&nbsp;

    &nbsp;&nbsp;

    <a class="btn btn-danger" href="{{ route('pissecthead.aprovalSectHeadSQE') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Sect Head Approval" id="btn-cancel">Back</a>
</div>
</section>
<!-- /.content -->
</div>
