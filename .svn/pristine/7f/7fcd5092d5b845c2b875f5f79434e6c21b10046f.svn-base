  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Approval PO Dept. Head</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> PROCUREMENT - TRANSAKSI - PO</li>
        <li class="active"><i class="fa fa-files-o"></i> Approval PO DEP</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Approval PO Dept. Head</h3>
        </div>
        <!-- /.box-header -->
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
              ...
              <select name="filter_status" aria-controls="filter_status" class="form-control select2">
                ...
                <option value="SEC" selected="selected">Approve Section</option>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var tableMaster = $('#tblMaster').DataTable({
      ...
      serverSide: true,
      ajax: "{{ route('baanpo1s.dashboarddep') }}",
      columns: [
