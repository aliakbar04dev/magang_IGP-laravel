...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        History Individual Development Plan
        <small>Detail History IDP <b>{{ $hrdtidpdep1->npk }} - {{ $hrdtidpdep1->tahun }} - {{ $hrdtidpdep1->kd_dep }}</b></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> Daftar IDP</li>
        <li class="active">Detail History IDP {{ $hrdtidpdep1->npk }} - {{ $hrdtidpdep1->tahun }} - {{ $hrdtidpdep1->kd_dep }}</li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Detail History IDP {{ $hrdtidpdep1->npk }} - {{ $hrdtidpdep1->tahun }} - {{ $hrdtidpdep1->desc_dep }}</h3>
            </div>
            <!-- /.box-header -->
      ...
      <div class="box-footer">
        <a target="_blank" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Print IDP {{ $hrdtidpdep1->npk }} - {{ $hrdtidpdep1->desc_dep }} - {{ $hrdtidpdep1->tahun }} (Revisi ke-{{ $hrdtidpdep1->revisi }})" href="{{ route('hrdtidpdep1s.printrevisi', base64_encode($hrdtidpdep1->id)) }}"><span class='glyphicon glyphicon-print'></span> Print IDP (Revisi ke-{{ $hrdtidpdep1->revisi }})</a>
          &nbsp;&nbsp;
