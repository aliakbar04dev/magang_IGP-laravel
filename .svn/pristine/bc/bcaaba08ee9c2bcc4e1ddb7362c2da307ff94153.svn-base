  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>CR Activities Progress</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> Budget - TRANSAKSI</li>
        <li class="active"><i class="fa fa-files-o"></i> CR Activities Progress</li>
      </ol>
    </section>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var tableMaster = $('#tblMaster').DataTable({
      ...
      serverSide: true,
      ajax: "{{ route('bgttcrsubmits.dashboard') }}",
      columns: [
      	{data: null, name: null},
        ...
        {data: 'persen', name: 'persen', className: "dt-right", orderable: false, searchable: false},
