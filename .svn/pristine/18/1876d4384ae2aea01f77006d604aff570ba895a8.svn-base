...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Lembur Oracle
        <small>Lembur Oracle</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="glyphicon glyphicon-phone"></i> HR - Mobile</li>
        <li class="active"><i class="fa fa-files-o"></i> Lembur Oracle</li>
      </ol>
    </section>
          ...
          <table id="tblMaster" class="table table-bordered table-striped" cellspacing="0" width="100%">
            <thead>
              <tr>
                ...
                <th>Nama</th>
                <th style="width: 20%;">Uang Lembur</th>
                <th>PT</th>
                <th>Divisi</th>
                <th>Departemen</th>
              </tr>
...
$(document).ready(function(){
  ...
  var tableMaster = $('#tblMaster').DataTable({
    ...
    serverSide: true,
    ajax: "{{ route('mobiles.dashboardlemburoracle') }}",
    columns: [
      {data: null, name: null},
      {data: 'npk', name: 'npk'},
      {data: 'nama', name: 'nama'},
      {data: 'uang_lembur', name: 'uang_lembur', className: "dt-right"},
