...
class EhstWp2K3sController extends Controller
{
    /**
    ...
    public function destroy(Request $request, $id)
    {
        if(Auth::user()->can('ehs-wp-delete')) {
            try {
                ...
                $ehstwp2k3 = EhstWp2K3::findOrFail(base64_decode($id));
                $ket_aktifitas = $ehstwp2k3->ket_aktifitas;
                if ($request->ajax()) {
                    $status = "OK";
                    ...
                    if(!$ehstwp2k3->delete()) {
                        ...
                        //insert logs
                        $log_keterangan = "EhstWp2K3sController.destroy: Delete Aktifitas ".$ket_aktifitas." Berhasil. ".base64_decode($id);
                    ...
                    if(!$ehstwp2k3->delete()) {
                        ...
                        return redirect()->route('ehstwp2k3s.index');
                    }
                }
