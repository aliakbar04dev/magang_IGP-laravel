...
var tableDetail = $('#table_airlimbah').DataTable({
 ...
 $("#table_airlimbah").on('preXhr.dt', function(e, settings, data) {
      ...
      swal(info, "Perhatikan inputan anda!", "info");
        ...
        success: function( _response ){
          ...
          swal(
            ...
            var urlRedirect = "{{route('ehsspaccidents.index_lvlairlimbah')}}";
...
function hapus_alimbah(id, id2)
   {
      ...
      swal({
        ...
        focusCancel: true,
          ...
          var urlRedirect = "{{route('ehsspaccidents.delete_lvlairlimbah', ['param', 'param2'])}}";
