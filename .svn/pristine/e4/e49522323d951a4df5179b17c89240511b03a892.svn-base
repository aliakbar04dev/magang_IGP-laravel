    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-4">
          ...
          <div class="input-group">
            {!! Form::select('kd_plant', array('1' => 'IGP-1', '2' => 'IGP-2', '3' => 'IGP-3', 'A' => 'IGP-KIM 1A', 'B' => 'IGP-KIM 1B'), null, ['class'=>'form-control']) !!}     
          </div>
        </div>
      </div>
      <div class="col-md-12">
