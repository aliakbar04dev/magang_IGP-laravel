  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Komite Investasi</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
      ...
      <div class="box-footer">
        @if ($bgttkomite1->checkKdDept() === "T" && $bgttkomite1->checkEdit() === "T")
          @if (Auth::user()->can(['budget-komite-create','budget-komite-delete']))
            @if (Auth::user()->can('budget-komite-create'))
              <a class="btn btn-primary" href="{{ route('bgttkomite1s.edit', base64_encode($bgttkomite1->no_komite)) }}" data-toggle="tooltip" data-placement="top" title="Ubah Data">Ubah Data</a>
              &nbsp;&nbsp;
            @endif
        ...
        @else 
          ...
          @endif
        @endif
        <a class="btn btn-primary" href="{{ route('bgttkomite1s.index') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Daftar Komite Investasi">Cancel</a>
      </div>
    </section>
    <!-- /.content -->
  </div>
...
<script type="text/javascript">
  ...
  $("#btn-delete").click(function(){
    var no_komite = "{{ $bgttkomite1->no_komite }}";
    var no_rev = "{{ $bgttkomite1->no_rev }}";
    var msg = 'Anda yakin menghapus No. Komite: ' + no_komite + ', No. Rev: ' + no_rev + '?';
