...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('qatsas.index') }}"><i class="fa fa-files-o"></i>QA - Special Acceptance</a></li>
      <li class="active">Special Acceptance</li> 
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Special Acceptance</h3>
      </div>
      <!-- /.box-header -->
      ...
      <div class="box-body form-horizontal"> 
        ...
        <p>
          <a class="btn btn-primary" href="{{ route('qatsas.create') }}"><span class="fa fa-plus"></span> Add Special Acceptance</a>
        </p>
        @endpermission 
        <!-- /.form-group -->
...
<script type="text/javascript">
  ...
  $(document).ready(function(){    
    var url = '{{ route('qatsas.dashboard') }}';
