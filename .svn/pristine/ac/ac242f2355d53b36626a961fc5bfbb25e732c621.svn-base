    ...
    <section class="content">
      ...
      <div class="box box-primary">        
            ...
            <div class="col-sm-2">
              ...
              <select size="1" id="plant" name="plant" class="form-control select2">
            ...
            <div class="col-sm-2">
              ...
              <select id="filter_status_status" name="filter_status_status" aria-controls="filter_status" class="form-control select2">
                <option value="ALL" selected="selected">All</option>
                <option value="1">Belum Approve</option>
                <option value="2">Approve</option>
                <option value="3">Reject</option>
                <option value="4">Approve Supplier</option>
                <option value="5">Reject Supplier</option>
                <option value="6">Sudah PICA</option>
              </select>
            </div>
            <div class="col-sm-2">
