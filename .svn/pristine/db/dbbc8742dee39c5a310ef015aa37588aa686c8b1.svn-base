...
<p>
	Telah disetujui Ijin Kerja dengan No: <strong>{{ $ehstwp1->no_wp }}</strong> oleh {{ $oleh }}: <strong>{{ Auth::user()->name }} ({{ Auth::user()->username }})</strong> dengan detail sebagai berikut:
</p>
