...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Daftar Genba DEP - Countermeasure
        <small>Detail Genba DEP - Countermeasure</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> MANAGEMENT - Transaksi</li>
        <li><a href="{{ route('mgmtgembadeps.indexcm') }}"><i class="fa fa-files-o"></i> Daftar Genba DEP - CM</a></li>
    ...
    <section class="content">
      ...
      <div class="box-footer">
        @if ($mgmtgembadep->npk_pic === Auth::user()->username || $mgmtgembadep->npk_pic_sub === Auth::user()->username)
          @if ($mgmtgembadep->st_gemba !== "T")
            <a class="btn btn-primary" href="{{ route('mgmtgembadeps.inputcm', base64_encode($mgmtgembadep->no_gemba)) }}" data-toggle="tooltip" data-placement="top" title="Input Countermeasure">Input Countermeasure</a>
            &nbsp;&nbsp;
          @elseif($mgmtgembadep->npk_pic === Auth::user()->username) 
            <a class="btn btn-primary" href="{{ route('mgmtgembadeps.inputcm', base64_encode($mgmtgembadep->no_gemba)) }}" data-toggle="tooltip" data-placement="top" title="Input Countermeasure">Input Countermeasure</a>
            &nbsp;&nbsp;
          @endif
        @endif
        <a class="btn btn-primary" href="{{ route('mgmtgembadeps.indexcm') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Dashboard Daftar Genba DEP - CM">Cancel</a>
      </div>
    </section>
    <!-- /.content -->
  </div>
