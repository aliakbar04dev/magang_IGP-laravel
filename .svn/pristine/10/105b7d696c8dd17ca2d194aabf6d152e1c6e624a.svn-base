...
<p>
	Telah dihapus Laporan Pekerjaan dengan No: <strong>{{ $tmtcwo1->no_wo }}</strong> oleh PIC: <strong>{{ Auth::user()->name }} ({{ Auth::user()->username }})</strong> dengan detail sebagai berikut:
</p>
