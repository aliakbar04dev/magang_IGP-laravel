...
<div class="panel panel-default">
  ...
  <div class="panel-body" >
      ...
      <div class="panel-body col-md-12">
        <div class="box-body" >
          <div class="col-md-12">
           {{-- ========= --}}
            <div class="form-group">
              {!! Form::label('approve_sect ', 'UPLOAD TTD', ['class'=>'col-md-2 control-label']) !!}
              <div class="col-md-4">
             ...
             <div class="form-group">
               ...
               <div class="col-md-4">
                 {!! Form::text('igpsect_nm', null, ['class'=>'form-control']) !!}
               </div>
             </div>
   ...
   <div class="box-footer col-md-12">
        ...
        &nbsp;&nbsp;
        <a class="btn btn-danger" href="{{ route('pissecthead.aprovalSectHeadSQE') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke approval sect head" id="btn-cancel">Back</a>
              &nbsp;&nbsp;
   </div> 
