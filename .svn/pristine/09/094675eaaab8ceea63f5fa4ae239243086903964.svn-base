...
@section('content')
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <center><h3 class="box-title" id="box-title" name="box-title" style="font-family:serif;font-size: 30px;"><strong>DAILY ACTIVITY ZONE IGP-{{ $kd_plant }} ZONA {{ $lok_zona }}<br>TANGGAL: {{ \Carbon\Carbon::now()->format('d F Y') }}</strong></h3></center>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="{{ route('smartmtcs.dailyactivity') }}" class="btn bg-navy">Back</a>
  </center>
    </footer>
@endsection
