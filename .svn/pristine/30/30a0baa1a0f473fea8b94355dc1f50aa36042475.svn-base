  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Detail EHS Patrol - Countermeasure</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Detail EHS Patrol</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-striped" cellspacing="0" width="100%">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width: 1%;"><b>:</b></td>
                    <td>{{ $mgmtgemba->npk_pic }} - {{ $mgmtgemba->nm_pic }}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="width: 12%;"><b>Kriteria</b></td>
                    <td style="width: 1%;"><b>:</b></td>
                    <td colspan="4" style="white-space:pre;">{{ $mgmtgemba->st_kriteria }} - {{ $mgmtgemba->nm_kriteria }}</td>
                  </tr>
                  <tr>
                    <td style="width: 12%;"><b>Rank</b></td>
                    <td style="width: 1%;"><b>:</b></td>
                    <td colspan="4" style="white-space:pre;">{{ $mgmtgemba->st_rank }} - {{ $mgmtgemba->nm_rank }}</td>
                  </tr>
                  <tr>
      ...
      <div class="box-footer">
        @if ($mgmtgemba->npk_pic === Auth::user()->username && $mgmtgemba->st_gemba !== "T")
          <a class="btn btn-primary" href="{{ route('mgmtgembaehss.inputcm', base64_encode($mgmtgemba->no_gemba)) }}" data-toggle="tooltip" data-placement="top" title="Input Countermeasure">Input Countermeasure</a>
          &nbsp;&nbsp;
        @endif
        <a class="btn btn-primary" href="{{ route('mgmtgembaehss.indexcm') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Dashboard Daftar EHS Patrol - CM">Cancel</a>
      </div>
    </section>
    <!-- /.content -->
  </div>
