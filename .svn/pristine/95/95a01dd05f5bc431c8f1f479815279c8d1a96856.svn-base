  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-files-o"></i> Daftar Masalah [Plant]</li>
      </ol>
    </section>
    	...
    	<div class="row">
	        <div class="col-md-12">
              ...
              <div class="box-header">
                <p> 
                  @permission(['mtc-dmplant-create'])
                  <a class="btn btn-primary" href="{{ route('mtctdftmslhplants.create') }}">
                    <span class="fa fa-plus"></span> Add Daftar Masalah [Plant]
                  </a>
                  @endpermission
                </p>
              </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var url = '{{ route('dashboard.mtctdftmslhplants') }}';
