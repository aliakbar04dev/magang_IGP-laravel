...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        History PICA
        <small>Detail History PICA</small>
      </h1>
      <ol class="breadcrumb">
        ...
        @endif
        <li class="active">Detail History {{ $pica->no_pica }}</li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Detail History PICA</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width: 20%;">
                      ...
                      @elseif (strlen(Auth::user()->username) > 5 && Auth::user()->can(['pica-create','pica-view','pica-submit']))
      ...
      <div class="box-footer">
        @if (Auth::user()->can(['pica-approve','pica-reject']))
          <a class="btn btn-primary" href="{{ route('picas.all') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Dashboard PICA">Kembali ke Dashboard PICA</a>
        @else
          <a class="btn btn-primary" href="{{ route('picas.index') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Dashboard PICA">Kembali ke Dashboard PICA</a>
        @endif
        &nbsp;&nbsp;
