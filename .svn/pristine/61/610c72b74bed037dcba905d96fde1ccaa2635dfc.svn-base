...
var tableDetail = $('#tblDetail').DataTable({
   ...
   //   responsive: true,
      ...
      ajax: "{{ route('mobiles.dashboardapprovallupaprik_sechead') }}",
      columns: [
  ...
  function konfirmasitolak(id)
  {
      ...
      swal({
       ...
       var urlRedirect = "{{route('mobiles.tolakapprovallupaprik_sechead', 'param')}}";    
  ...
  function konfirmasisetuju(id)
   {
      ...
      swal({
        ...
        focusCancel: true,
          ...
          var urlRedirect = "{{route('mobiles.setujuapprovallupaprik_sechead', 'param')}}";    
          urlRedirect = urlRedirect.replace('param', id);
