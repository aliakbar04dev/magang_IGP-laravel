...
<div class="box-footer">
  ...
  @if (!empty($prodnpk->npk))
    ...
    &nbsp;&nbsp;
  @endif
  <a class="btn btn-default" href="{{ route('prodnpks.index') }}">Cancel</a>
    &nbsp;&nbsp;<p class="help-block pull-right has-error">{!! Form::label('info', '(*) tidak boleh kosong', ['style'=>'color:red']) !!}</p>
</div>

<!-- Modal Karyawan -->
@include('eqc.plant.popup.karyawanModal')
...
<script type="text/javascript">
  ...
  function popupKaryawan() {
    ...
    url = url.replace('param', window.btoa("PROD"));
