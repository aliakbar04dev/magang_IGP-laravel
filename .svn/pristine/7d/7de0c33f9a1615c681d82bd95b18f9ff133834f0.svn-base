          ...
          <div class="box-body">
            <div class="row form-group">
              <div class="col-sm-2 {{ $errors->has('finish_weight_kg') ? ' has-error' : '' }}">
                ...
                {!! Form::number('finish_weight_kg', !empty($prctrfq->prctRfqRm()) ? numberFormatterForm(0, 2)->format($prctrfq->prctRfqRm()->finish_weight_kg) : null, ['class'=>'form-control', 'placeholder' => 'Part Weight (KG)', 'max' => 9999999999.99, 'step' => 'any', 'id' => 'finish_weight_kg', 'onchange' => 'refreshTotal()', 'style' => 'text-align:right;', 'readonly' => 'readonly']) !!}
              ...
              <div class="col-sm-2 {{ $errors->has('mat_consump_kg') ? ' has-error' : '' }}">
                ...
                {!! Form::number('mat_consump_kg', !empty($prctrfq->prctRfqRm()) ? numberFormatterForm(0, 2)->format($prctrfq->prctRfqRm()->mat_consump_kg) : null, ['class'=>'form-control', 'placeholder' => 'Consumption (KG)', 'max' => 9999999999.99, 'step' => 'any', 'id' => 'mat_consump_kg', 'onchange' => 'refreshTotal()', 'style' => 'text-align:right;', 'readonly' => 'readonly']) !!}
              ...
              <div class="col-sm-2 {{ $errors->has('scrap_kg') ? ' has-error' : '' }}">
                ...
                {!! Form::number('scrap_kg', !empty($prctrfq->prctRfqRm()) ? numberFormatterForm(0, 2)->format($prctrfq->prctRfqRm()->scrap_kg) : null, ['class'=>'form-control', 'placeholder' => 'Scrap (KG)', 'max' => 9999999999.99, 'step' => 'any', 'id' => 'scrap_kg', 'onchange' => 'refreshTotal()', 'style' => 'text-align:right;', 'readonly' => 'readonly']) !!}
              ...
              <div class="col-sm-2 {{ $errors->has('scrap_pric_per_kg') ? ' has-error' : '' }}">
                ...
                {!! Form::number('scrap_pric_per_kg', !empty($prctrfq->prctRfqRm()) ? numberFormatterForm(0, 2)->format($prctrfq->prctRfqRm()->scrap_pric_per_kg) : null, ['class'=>'form-control', 'placeholder' => 'Scrap / Kg (IDR)', 'max' => 9999999999.99, 'step' => 'any', 'id' => 'scrap_pric_per_kg', 'onchange' => 'refreshTotal()', 'style' => 'text-align:right;', 'readonly' => 'readonly']) !!}
