  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-files-o"></i>Parameter Hardening</li>
      </ol>
    </section>
          ...
          <div class="col-md-12">
            <div class="box box-primary">
              ...
              <div class="box-header">
                <p> 
                  <a class="btn btn-primary" href="{{ route('prodparamharden.create') }}">
                    <span class="fa fa-plus"></span> Add Parameter Hardening
                  </a>
                </p>
              </div>
              <!-- /.box-header -->
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    var url = "{{ route('prodparamharden.dashboard') }}";
