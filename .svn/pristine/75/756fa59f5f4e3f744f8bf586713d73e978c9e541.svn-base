...
<p>
	Mohon maaf, Individual Development Plan Department Head telah ditolak oleh: {{ Auth::user()->name }} ({{ Auth::user()->username }}) pada tanggal {{ \Carbon\Carbon::now()->format('d M Y H:i') }} dengan detail sebagai berikut:
</p>
