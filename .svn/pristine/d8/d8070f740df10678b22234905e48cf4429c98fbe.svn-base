...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Monitoring PKL
        <small>Monitoring PKL</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="glyphicon glyphicon-info-sign"></i> Employee Info</li>
        <li class="active"><i class="fa fa-files-o"></i> Monitoring PKL</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      @if (Auth::user()->username === "14438")
        <div>
        <a class="btn btn-danger" href="{{ route('mobiles.monitoringpklall') }}" data-toggle="tooltip" data-placement="top" title="Monitoring PKL ALL">Monitoring PKL ALL</a>
        </div>
        <!-- /.box -->
      @endif
    </section>
...
$(document).ready(function(){
  ...
  var tableMaster = $('#tblMaster').DataTable({
    ...
    serverSide: true,
    ajax: "{{ route('mobiles.dashboardmonitoringpkl') }}",
    columns: [
      {data: null, name: null},
      {data: 'no_pkl', name: 'no_pkl'},
      ...
      {data: 'print_by', name: 'print_by', className: "none"},
