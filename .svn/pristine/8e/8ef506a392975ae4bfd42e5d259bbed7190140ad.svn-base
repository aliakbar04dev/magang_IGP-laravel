    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Update Work Order</h3>
        </div>
        <!-- /.box-header -->
        
        <!-- form start -->
        {!! Form::model($wo, ['url' => route('wos.update', base64_encode($wo->id)),
