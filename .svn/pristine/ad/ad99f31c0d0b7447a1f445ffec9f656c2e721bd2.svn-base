...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('mstalatukur.index') }}"><i class="fa fa-files-o"></i>QC - Alat Ukur</a></li>
  ...
  <section class="content">
    ...
    <div class="box box-primary">
      ...
      <div class="box-body form-horizontal">
        ...
        <p>
          <a class="btn btn-primary" href="{{ route('mstalatukur.create') }}"><span class="fa fa-plus"></span> Add Master Alat Ukur</a>
        </p>
        @endpermission
        ...
        <div class="col-sm-2">
          ...
          <div class="input-group">
            {!! Form::select('tipe', ['K' => 'KALIBRASI', 'V' => 'VERIFIKASI'], null, ['class'=>'form-control select2','placeholder' => 'Pilih Tipe', 'id' => 'tipe']) !!}            
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var url = '{{ route('mstalatukur.dashboard') }}';
