...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Lalu Lintas - Accounting ke Finance
        {{-- <small>Lalu Lintas - Accounting ke Finance</small> --}}
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> FACO - Lalu Lintas</li>
        <li class="active"><i class="fa fa-files-o"></i> Accounting ke Finance</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header">
              <p> 
                @permission(['faco-lalin-acc-fin'])
                <a class="btn btn-primary" href="{{ route('lalins.createaccfin') }}">
                  <span class="fa fa-plus"></span> Serah dari Accounting ke Finance
                </a>
                @endpermission
              </p>
            </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var url = '{{ route('lalins.dashboardaccfin') }}';
      ...
      columns: [
        ...
        {data: 'tgl_laf', name: 'tgl_laf', className: "dt-center"},
        {data: 'ket_laf', name: 'ket_laf'},
