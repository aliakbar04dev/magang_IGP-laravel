  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Slip Potongan Koperasi</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="glyphicon glyphicon-info-sign"></i> Employee Info</li>
        <li class="active"><i class="fa fa-files-o"></i> Slip Potongan Koperasi</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-primary">        
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              {!! Form::label('lblview', ' ') !!}
              <button id="btn-view" type="button" class="form-control btn btn-primary" data-toggle="tooltip" data-placement="top" title="View Slip Potongan Koperasi">View Slip Potongan Koperasi</button>
            </div>
    		  </div>
    		  <!-- /.form-group -->
    		</div>
...
$("#btn-view").click(function(){
  ...
  var urlRedirect = '{{ route('mobiles.viewpotkoperasi', ['param', 'param2']) }}';
