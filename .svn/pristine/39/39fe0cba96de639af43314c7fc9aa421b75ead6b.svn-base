    ...
    <div class="box-body">
      <div class="row form-group">
        <div class="col-sm-2 {{ $errors->has('finish_weight_kg') ? ' has-error' : '' }}">
          ...
          {!! Form::number('finish_weight_kg', !empty($prctrfq->prctRfqRm()) ? numberFormatterForm(0, 2)->format($prctrfq->prctRfqRm()->finish_weight_kg) : null, ['class'=>'form-control', 'placeholder' => 'Part Weight (KG)', 'max' => 9999999999.99, 'step' => 'any', 'id' => 'finish_weight_kg', 'onchange' => 'refreshTotal()', 'style' => 'text-align:right;']) !!}
        ...
        <div class="col-sm-2 {{ $errors->has('mat_consump_kg') ? ' has-error' : '' }}">
          {!! Form::label('mat_consump_kg', 'Consumption (KG)') !!}
          {!! Form::number('mat_consump_kg', !empty($prctrfq->prctRfqRm()) ? numberFormatterForm(0, 2)->format($prctrfq->prctRfqRm()->mat_consump_kg) : null, ['class'=>'form-control', 'placeholder' => 'Consumption (KG)', 'max' => 9999999999.99, 'step' => 'any', 'id' => 'mat_consump_kg', 'onchange' => 'refreshTotal()', 'style' => 'text-align:right;']) !!}
          {!! $errors->first('mat_consump_kg', '<p class="help-block">:message</p>') !!}
        </div>
        <div class="col-sm-2 {{ $errors->has('pric_per_kg_idr') ? ' has-error' : '' }}">
          {!! Form::label('pric_per_kg_idr', 'Price / Kg (IDR)') !!}
          {!! Form::number('pric_per_kg_idr', !empty($prctrfq->prctRfqRm()) ? numberFormatterForm(0, 2)->format($prctrfq->prctRfqRm()->pric_per_kg_idr) : null, ['class'=>'form-control', 'placeholder' => 'Price / Kg (IDR)', 'max' => 9999999999.99, 'step' => 'any', 'id' => 'pric_per_kg_idr', 'onchange' => 'refreshTotal()', 'style' => 'text-align:right;']) !!}
          {!! $errors->first('pric_per_kg_idr', '<p class="help-block">:message</p>') !!}
        </div>
        <div class="col-sm-2 {{ $errors->has('scrap_kg') ? ' has-error' : '' }}">
          {!! Form::label('scrap_kg', 'Scrap (KG)') !!}
          {!! Form::number('scrap_kg', !empty($prctrfq->prctRfqRm()) ? numberFormatterForm(0, 2)->format($prctrfq->prctRfqRm()->scrap_kg) : null, ['class'=>'form-control', 'placeholder' => 'Scrap (KG)', 'max' => 9999999999.99, 'step' => 'any', 'id' => 'scrap_kg', 'onchange' => 'refreshTotal()', 'style' => 'text-align:right;']) !!}
          {!! $errors->first('scrap_kg', '<p class="help-block">:message</p>') !!}
        </div>
        <div class="col-sm-2 {{ $errors->has('scrap_pric_per_kg') ? ' has-error' : '' }}">
          {!! Form::label('scrap_pric_per_kg', 'Scrap / Kg (IDR)') !!}
          {!! Form::number('scrap_pric_per_kg', !empty($prctrfq->prctRfqRm()) ? numberFormatterForm(0, 2)->format($prctrfq->prctRfqRm()->scrap_pric_per_kg) : null, ['class'=>'form-control', 'placeholder' => 'Scrap / Kg (IDR)', 'max' => 9999999999.99, 'step' => 'any', 'id' => 'scrap_pric_per_kg', 'onchange' => 'refreshTotal()', 'style' => 'text-align:right;']) !!}
          {!! $errors->first('scrap_pric_per_kg', '<p class="help-block">:message</p>') !!}
        </div>
        <div class="col-sm-2 {{ $errors->has('ttl_mat') ? ' has-error' : '' }} pull-right">
...
<script type="text/javascript">
  ...
  function refreshTab() {
    ...
    if(st_rm === "T") {
      ...
      document.getElementById("finish_weight_kg").focus();
    } else if(st_proses === "T") {
  ...
  function refreshTotal() {
    ...
    //1. Raw Material
    var finish_weight_kg = document.getElementById("finish_weight_kg").value.trim();
    finish_weight_kg = Number(finish_weight_kg);
    var mat_consump_kg = document.getElementById("mat_consump_kg").value.trim();
    ...
    var scrap_kg = document.getElementById("scrap_kg").value.trim();
    scrap_kg = Number(scrap_kg);
    var scrap_pric_per_kg = document.getElementById("scrap_pric_per_kg").value.trim();
    scrap_pric_per_kg = Number(scrap_pric_per_kg);

    var ttl_mat = (mat_consump_kg * pric_per_kg_idr) - (scrap_kg * scrap_pric_per_kg);
