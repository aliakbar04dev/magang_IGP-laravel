  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Add Kebutuhan Spare Parts Plant</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Add Kebutuhan Spare Parts Plant</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Add Kebutuhan Spare Parts Plant</h3>
        </div>
        <!-- /.box-header -->
        
        <!-- form start -->
        {!! Form::open(['url' => route('mtctlogpkbs.store'),
