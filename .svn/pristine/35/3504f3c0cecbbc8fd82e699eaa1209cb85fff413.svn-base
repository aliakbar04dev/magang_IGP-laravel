...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ENG - CYCLE TIME
        <small>ENG - CYCLE TIME</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-truck"></i> ENG - LAPORAN</li>
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
          ...
          <div class="form-group">
            ...
            @permission(['eng-cycletime-upload'])
              <div class="col-sm-2">
    ...
    $("#btn-upload").click(function(){
      swal({
        ...
        if(file == null) {
          ...
          url = url.replace('param5', window.btoa("ENG"));
