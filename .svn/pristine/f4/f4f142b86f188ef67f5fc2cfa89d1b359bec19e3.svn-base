  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Detail Approval PO Div. Head</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> PROCUREMENT - TRANSAKSI - PO</li>
        <li><a href="{{ route('baanpo1s.indexdiv') }}"><i class="fa fa-files-o"></i> Approval PO DIV</a></li>
    ...
    <section class="content">
      ...
      <div class="box-footer">
        @if (Auth::user()->can(['prc-po-apr-pic', 'prc-po-apr-sh', 'prc-po-apr-dep', 'prc-po-apr-div', 'prc-po-apr-download']))
          ...
          @endif
        @endif
        <a class="btn btn-primary" href="{{ route('baanpo1s.indexdiv') }}" data-toggle="tooltip" data-placement="top" title="Kembali ke Dashboard Approval PO Div. Head">Cancel</a>
      </div>
    </section>
    <!-- /.content -->
  </div>
