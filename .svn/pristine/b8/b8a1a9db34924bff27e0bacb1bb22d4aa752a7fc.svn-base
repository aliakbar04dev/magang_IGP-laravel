...
class MtctDftMslhPlant extends Model
{
    ...
    protected $fillable = [
    	'no_dm', 'tgl_dm', 'kd_site', 'kd_line', 'kd_mesin', 'ket_prob', 'dtcrea', 'creaby', 'dtmodi', 'modiby', 'lok_pict', 'kd_plant', 'kd_dep', 
    ];
    ...
    public static function boot()
	{
        ...
        self::deleting(function($mtctdftmslh) {
            ...
            if($mtctdftmslh->tmtcwo1() != null) {
                ...
                $msg = "Daftar Masalah: $mtctdftmslh->no_dm tidak bisa dihapus karena sudah ada Counter Measure.";
            } else {
