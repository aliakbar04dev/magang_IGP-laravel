            ...
            <table id="tblMaster" class="table table-bordered" border="2" width="100%">
              ...
              <tr>
                <td style="width: 45%;text-align: center">
                  <center><img src="{{ $smartmtc->fotokpi($npk."_MA_RA-1A.png") }}" class="img-rounded img-responsive" alt="File Not Found" style="width: 100%;height: 100%;" data-toggle="modal" data-target="#imgModal" onclick="showPict('Picture', '{{ $smartmtc->fotokpi($npk."_MA_RA-1A.png") }}')"></center>
                </td>
                <td style="width: 45%;text-align: center">
                  <center><img src="{{ $smartmtc->fotokpi($npk."_MA_PH-TUBE.png") }}" class="img-rounded img-responsive" alt="File Not Found" style="width: 100%;height: 100%;" data-toggle="modal" data-target="#imgModal" onclick="showPict('Picture', '{{ $smartmtc->fotokpi($npk."_MA_PH-TUBE.png") }}')"></center>
                </td>
              </tr>
              <tr>
                <td style="width: 45%;text-align: center">
                  <center><img src="{{ $smartmtc->fotokpi($npk."_MA_CF.png") }}" class="img-rounded img-responsive" alt="File Not Found" style="width: 100%;height: 100%;" data-toggle="modal" data-target="#imgModal" onclick="showPict('Picture', '{{ $smartmtc->fotokpi($npk."_MA_CF.png") }}')"></center>
                </td>
                <td style="width: 45%;text-align: center">
                  &nbsp;
                </td>
              ...
              <tr>
                <td style="width: 45%;text-align: center">
                  <center><img src="{{ $smartmtc->fotokpi($npk."_PMA_RA-1A.png") }}" class="img-rounded img-responsive" alt="File Not Found" style="width: 100%;height: 100%;" data-toggle="modal" data-target="#imgModal" onclick="showPict('Picture', '{{ $smartmtc->fotokpi($npk."_PMA_RA-1A.png") }}')"></center>
                </td>
                <td style="width: 45%;text-align: center">
                  <center><img src="{{ $smartmtc->fotokpi($npk."_PH-TUBE.png") }}" class="img-rounded img-responsive" alt="File Not Found" style="width: 100%;height: 100%;" data-toggle="modal" data-target="#imgModal" onclick="showPict('Picture', '{{ $smartmtc->fotokpi($npk."_PH-TUBE.png") }}')"></center>
                </td>
              </tr>
              <tr>
                <td style="width: 45%;text-align: center">
                  <center><img src="{{ $smartmtc->fotokpi($npk."_PMA_CF.png") }}" class="img-rounded img-responsive" alt="File Not Found" style="width: 100%;height: 100%;" data-toggle="modal" data-target="#imgModal" onclick="showPict('Picture', '{{ $smartmtc->fotokpi($npk."_PMA_CF.png") }}')"></center>
                </td>
                <td style="width: 45%;text-align: center">
                  &nbsp;
                </td>
