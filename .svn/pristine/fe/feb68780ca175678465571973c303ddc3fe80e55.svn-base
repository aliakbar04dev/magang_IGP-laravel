...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Laporan Equipment Facility
        <small>Laporan Equipment Facility</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><i class="fa fa-files-o"></i> Laporan</li>
        <li class="active"><i class="fa fa-files-o"></i> Equipment Facility</li>
      </ol>
    </section>
            ...
            <div class="box-body form-horizontal">
              <div class="form-group">
                ...
                <div class="col-sm-2" style="display:none;">
                  ...
                  <button id="btn-proses" name="btn-proses" type="button" class="form-control btn btn-warning" data-toggle="tooltip" data-placement="top" title="Proses Laporan">Proses Laporan</button>
                </div>
              </div>
              <!-- /.form-group -->
            </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('#btn-proses').click( function () {
      var tahun = $('select[name="filter_tahun"]').val();
      var bulan = $('select[name="filter_bulan"]').val();
      var urlRedirect = "{{ route('ehsenvreps.proseslaporan', ['param','param2']) }}";
