            ...
            @foreach ($prctrfq->prctRfqProsess() as $model)
              ...
              <div class="row form-group" id="proses_field2_{{ $loop->iteration }}">
                ...
                <div class="col-sm-2">
                  ...
                  <input type="number" id="proses_ct_proses_dtk_{{ $loop->iteration }}" name="proses_ct_proses_dtk_{{ $loop->iteration }}" class="form-control" placeholder="Cycle Time" max="9999999999.99" step="any" onchange="refreshTotal()" style="text-align:right;" value="{{ numberFormatterForm(0, 2)->format($model->ct_proses_dtk) }}" readonly="readonly">
                </div>
                <div class="col-sm-3">
