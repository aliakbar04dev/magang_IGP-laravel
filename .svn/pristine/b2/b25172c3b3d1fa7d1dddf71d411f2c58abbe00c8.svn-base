  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-lock"></i> User</li>
      </ol>
    </section>
	        ...
	        <div class="col-md-12">
	          <div class="box box-primary">
	            <div class="box-header">
	              @permission(['admin-create','user-create'])
                  <p>
                    <a class="btn btn-primary" href="{{ route('users.create') }}"><span class="fa fa-user-plus"></span> Add User</a>
                    @if (Auth::user()->username === "ian")
                      &nbsp;&nbsp;
                      <a class="btn btn-primary" href="{{ route('cleanup.users') }}"><span class="fa fa-trash"></span> Cleanup Data</a>
                    @endif
                  </p>
				        @endpermission
	            </div>
   ...
   $(document).ready(function(){
    ...
    $(function() {
  	  $('\
  	    ...
  	    <div id="filter_status_user" class="dataTables_length" style="display: inline-block; margin-left:10px;">\
  	      <label>Status User \
  	      <select size="1" name="filter_status_user" aria-controls="filter_status_user" \
  	        class="form-control select2" style="width: 100px;">\
  	          <option value="all" selected="selected">Semua</option>\
  	  ...
  	  $('select[name="filter_status_user"]').change(function() {
  	    tableMaster.ajax.reload();
  	  });
