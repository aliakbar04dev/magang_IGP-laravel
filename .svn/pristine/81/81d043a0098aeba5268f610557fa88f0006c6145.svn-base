  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-files-o"></i>Approval Suket Pengajuan</li>
      </ol>
    </section>
          ...
          <div class="col-md-12">
            <div class="box box-primary">
              <div class="box-header">
                <p> 
                  Approval Suket Pengajuan (Untuk Atasan  dan HRD)
                  </a>
                </p>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                ...
                <table id="tblDetail" class="table table-bordered table-striped" cellspacing="0" width="100%">
                      <thead>
                            <tr>
                                <th width="20">No</th>
                                <th width="65">No. SK</th>
                                <th width="65">Tanggal Surat</th>
                                <th width="85">Nama Karyawan</th>
                                <th width="50">Aksi</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var tableDetail = $('#tblDetail').DataTable({
      ...
      ajax: "{{ route('mobiles.dashboardsuketpengajuan') }}",
      columns: [
