...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('kalserti.indexapp') }}"><i class="fa fa-files-o"></i>QA - Autorisasi Sertifikat</a></li>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body form-horizontal"> 
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            {!! Form::label('status', 'Status Autorisasi') !!}
            <div class="input-group">
              {!! Form::select('status', array('ALL' => 'ALL', 'SUDAH' => 'SUDAH AUTORISASI', 'BELUM' => 'BELUM AUTORISASI'), 'BELUM', ['class'=>'form-control']) !!}
        ...
        <table id="tblMaster" class="table table-bordered table-striped" cellspacing="0" width="100%">
          <thead>
            <tr>
              ...
              <th style="width: 5%;">PIC Autorisasi</th>
              <th style="width: 5%;">Tgl Autorisasi</th> 
...
<script type="text/javascript">
  ...
  $(document).ready(function(){    
    var url = '{{ route('kalserti.dashboardapp') }}';
    var tableMaster = $('#tblMaster').DataTable({
      ...
      {data: 'pic_autor', name: 'pic_autor'},
      {data: 'tgl_autorisasi', name: 'tgl_autorisasi'},
